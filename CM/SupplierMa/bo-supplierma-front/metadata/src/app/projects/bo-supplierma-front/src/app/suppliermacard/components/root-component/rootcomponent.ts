...
import { rootviewmodelDataImport1Handler } from '../../viewmodels/handlers/rootviewmodeldataimport1handler';
import { rootviewmodelDataExport1Handler } from '../../viewmodels/handlers/rootviewmodeldataexport1handler';
import { rootviewmodelDataExport2Handler } from '../../viewmodels/handlers/rootviewmodeldataexport2handler';
...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.stateMachine.stateChange.subscribe(() => {
            ...
            const states = {
                'button-add-suppliermaterial': !this.viewModel.stateMachine['canAddDetail'],
                'button-remove-suppliermaterial': !this.viewModel.stateMachine['canRemoveDetail'],
        ...
        contents: [
            {
                ...
                visible: true,
                title: this.langService.transform('button-add-suppliermaterial', this.lang, "新增"),
                click: ($event) => { this.viewModel.suppliermaterialComponentViewmodel.suppliermaterialAddItem1($event); },
                appearance: {
            ...
            },
            {
                ...
                visible: true,
                title: this.langService.transform('button-remove-suppliermaterial', this.lang, "删除"),
                click: ($event) => { this.viewModel.suppliermaterialComponentViewmodel.suppliermaterialRemoveItem1($event); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            },
            {
                ...
                disable: false,
                visible: true,
                title: this.langService.transform('sectionToolbarItem-1c3i', this.lang, "导入"),
                click: ($event) => { this.viewModel.rootviewmodelDataImport1($event); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            },
            {
                ...
                disable: false,
                visible: true,
                title: this.langService.transform('sectionToolbarItem-43bh', this.lang, "导出全部"),
                click: ($event) => { this.viewModel.rootviewmodelDataExport1($event); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            },
            {
                ...
                disable: false,
                visible: true,
                title: this.langService.transform('sectionToolbarItem-42qy', this.lang, "导出勾选"),
                click: ($event) => { this.viewModel.rootviewmodelDataExport2($event); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
    ...
    SectionsectionsuppliermaterialMainTitle = this.langService.transform('Section/section-suppliermaterial/mainTitle', this.lang, "供应商对应物料");
    SectionsectionsuppliermaterialSubTitle = this.langService.transform('Section/section-suppliermaterial/subTitle', this.lang, "");
    ScrollspyItemsscrollspy = [
        {
            "id": "basic-form-section",
            "visible": true,
            "title": this.langService.transform('Scrollspy/scrollspy/items/basic-form-section', this.lang, "基本信息")
        },
        {
            "id": "section-suppliermaterial",
            "visible": true,
            "title": this.langService.transform('Scrollspy/scrollspy/items/section-suppliermaterial', this.lang, "供应商对应物料")
        },
        {
            "id": "supplierma-ohol-form-section",
            "visible": true,
            "title": this.langService.transform('Scrollspy/scrollspy/items/supplierma-ohol-form-section', this.lang, "联系方式")
        }
    ];
    ScrollspyCurrentSectionscrollspy = "basic-form-section";
}