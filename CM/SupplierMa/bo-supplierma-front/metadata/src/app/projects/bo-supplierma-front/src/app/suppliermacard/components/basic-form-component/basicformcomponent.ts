...
export class BasicFormComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    signTime_36e6b73d_4lns_PlaceHolder = this.langService.transform('DateBox/signTime_36e6b73d_4lns/placeHolder', this.lang, "");
    supplierName_2df5f154_jtkg_PlaceHolder = this.langService.transform('TextBox/supplierName_2df5f154_jtkg/placeHolder', this.lang, "");
    supplierCode_a55cbab4_vw3m_PlaceHolder = this.langService.transform('TextBox/supplierCode_a55cbab4_vw3m/placeHolder', this.lang, "");
}