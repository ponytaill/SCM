...
import { SupplierMaCardRoutingModule } from './routing';
import { DataImpExpModule } from '@gsp-dip/data-imp-exp';
...
import { SuppliermaterialComponent } from './components/suppliermaterial-component/suppliermaterialcomponent';
import { SuppliermaOholComponent } from './components/supplierma-ohol-component/suppliermaoholcomponent';
...
var SupplierMaCardModule = /** @class */ (function () {
    ...
    SupplierMaCardModule = tslib_1.__decorate([
        NgModule({
            exports: [
                RootComponent
            ],
