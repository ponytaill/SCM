...
var suppliermaterialRemoveItem1Handler = /** @class */ (function (_super) {
    tslib_1.__extends(suppliermaterialRemoveItem1Handler, _super);
    ...
    suppliermaterialRemoveItem1Handler = tslib_1.__decorate([
        Injectable(),
        NgCommandHandler({
...
export { suppliermaterialRemoveItem1Handler };
