...
var ɵ0 = function (context) { return context.state === 'init'; }, ɵ1 = function (context) { return context.state === 'add' || context.state === 'edit'; }, ɵ2 = function (context) { return context.state === 'init'; }, ɵ3 = function (context) { return context.state === 'add' || context.state === 'edit'; }, ɵ4 = function (context) { return context.state === 'init'; }, ɵ5 = function (context) { return context.state === 'add' || context.state === 'edit'; }, ɵ6 = function (context) { return context.getUIState('{UISTATE~/root-component/action}') === 'LoadAndAdd1' || context.getUIState('{UISTATE~/root-component/action}') === 'LoadAndEdit1'; }, ɵ7 = function (context) { return context.state === 'add' || context.state === 'edit'; }, ɵ8 = function (context) { return context.state === 'add' || context.state === 'edit'; };
