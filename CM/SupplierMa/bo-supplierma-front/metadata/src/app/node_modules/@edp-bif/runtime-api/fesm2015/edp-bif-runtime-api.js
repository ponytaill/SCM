...
import { AppType, FrameworkService, LoadingService as LoadingService$1, FrmEventBus, FuncsService, AppService } from '@gsp-sys/rtf-common';
...
import { InjectionToken, Pipe, Inject, LOCALE_ID, ComponentFactoryResolver, Injectable, Injector, NgModuleFactoryLoader, Optional, ComponentRef, ReflectiveInjector, Component, ElementRef, NgModule, SystemJsNgModuleLoader, ViewChild, Output, EventEmitter, Input, ViewContainerRef, ChangeDetectorRef, ChangeDetectionStrategy, ApplicationRef, Directive } from '@angular/core';
...
class PullSelectorComponent {
    ...
    loadItems() {
        ...
        (result) => {
             ...
             */
            elt => {
                if (this.voIdList.includes(elt.upBillVoId) === false) {
                    this.voIdList.push(elt.upBillVoId);
                    this.entityDict[elt.upBillVoId] = new Array();
                }
                this.nameDict[elt.upBillVoId] = elt.upBillVoName;
                this.entityDict[elt.upBillVoId].push(elt);
            }));
            this.selectedVoId = this.voIdList.length > 0 ? this.voIdList[0] : null;
            this.loading.close();
        }), (/**
