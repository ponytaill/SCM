(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@farris/kendo-binding', ['exports', '@farris/ui-common/number', '@progress/kendo-angular-dropdowns', 'lodash-es', '@farris/extend-file-upload', 'rxjs', 'rxjs/operators', 'primeng/treetable', '@farris/ui-common/date', '@farris/ui-editor', '@gsp-cmp/querysolution', '@farris/ui-text', '@farris/ui-list-view', '@farris/ui-list-filter', '@farris/ui-filter', '@farris/ui-view-change', '@farris/ui-html-editor', '@farris/ui-section', '@farris/ui-input-group', '@farris/ui-datepicker', '@farris/ui-time-picker', '@farris/ui-number-spinner', '@farris/ui-combo-list', '@farris/ui-lookup', '@farris/ui-datagrid', '@farris/ui-treetable', '@farris/ui-wizard', '@farris/discussion-group', '@farris/ui-list-nav', '@farris/ui-multi-select', '@farris/ui-scrollspy', '@farris/ui-combo-lookup', '@gsp-svc/formdoc-upload', '@farris/ui-locale', '@farris/ui-common/column', '@farris/devkit', 'bignumber.js', 'moment', '@farris/ui-dialog', '@angular/core', '@angular/common', '@progress/kendo-angular-grid', '@farris/ui-common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['kendo-binding'] = {}),global.number,global.kendoAngularDropdowns,global.lodashEs,global.extendFileUpload,global.rxjs,global.rxjs.operators,global.treetable,global.date,global.uiEditor,global.querysolution,global.uiText,global.uiListView,global.uiListFilter,global.uiFilter,global.uiViewChange,global.uiHtmlEditor,global.uiSection,global.uiInputGroup,global.uiDatepicker,global.uiTimePicker,global.uiNumberSpinner,global.uiComboList,global.uiLookup,global.uiDatagrid,global.uiTreetable,global.uiWizard,global.discussionGroup,global.uiListNav,global.uiMultiSelect,global.uiScrollspy,global.uiComboLookup,global.formdocUpload,global.uiLocale,global.column,global.devkit,global.bignumber_js,global.moment,global.uiDialog,global.ng.core,global.ng.common,global.kendoAngularGrid,global.uiCommon));
}(this, (function (exports,number,kendoAngularDropdowns,lodashEs,extendFileUpload,rxjs,operators,treetable,date,uiEditor,querysolution,uiText,uiListView,uiListFilter,uiFilter,uiViewChange,uiHtmlEditor,uiSection,uiInputGroup,uiDatepicker,uiTimePicker,uiNumberSpinner,uiComboList,uiLookup,uiDatagrid,uiTreetable,uiWizard,discussionGroup,uiListNav,uiMultiSelect,uiScrollspy,uiComboLookup,formdocUpload,uiLocale,column,devkit,bignumber_js,moment,uiDialog,core,common,kendoAngularGrid,uiCommon) { 'use strict';
            ...
            this.beginEditSubscription = this.grid.beginEdit.subscribe(function (e) {
                ...
                if (column$$1 && column$$1.editor) {
                    ...
                    if (column$$1.editor.type === 'lookup' || column$$1.editor.type === 'PersonnelSelector'
                        || column$$1.editor.type === 'OrganizationSelector' || column$$1.editor.type === 'external-integration') {
