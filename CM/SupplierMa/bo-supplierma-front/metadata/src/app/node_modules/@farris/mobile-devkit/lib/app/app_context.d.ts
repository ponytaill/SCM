...
declare class AppContext extends Context {
     ...
     * 构造函数
     */
    constructor(injector: Injector, eventBus: AppEventBus, repositoryManager: RepositoryManager, bindingDataManager: BindingDataManager, viewModelContextManager: ViewModelContextManager);
    /**
     * 注册FrameContext
     */
