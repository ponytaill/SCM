(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('axios'), require('reflect-metadata'), require('date-fns'), require('dayjs'), require('dayjs/plugin/IsBetween'), require('dayjs/plugin/relativeTime'), require('dayjs/plugin/calendar'), require('dayjs/locale/zh-cn')) :
    typeof define === 'function' && define.amd ? define('@farris/mobile-devkit', ['exports', 'rxjs', 'rxjs/operators', 'axios', 'reflect-metadata', 'date-fns', 'dayjs', 'dayjs/plugin/IsBetween', 'dayjs/plugin/relativeTime', 'dayjs/plugin/calendar', 'dayjs/locale/zh-cn'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['mobile-devkit'] = {}), global.rxjs, global.rxjs.operators, global.axios, null, global.dateFns, global.dayjs, global.IsBetween, global.relativeTime, global.Calendar));
}(this, (function (exports, rxjs, operators, axios, reflectMetadata, dateFns, dayjs, IsBetween, relativeTime, Calendar) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ChangeSet = /** @class */ (function () {
        ...
        ChangeSet.prototype.appendRemoveModification = function (modification) {
            ...
            this.modifications.forEach(function (addModification) {
                // 只处理新增变更
                if (addModification.type !== exports.ModifyType.Add) {
                    return;
                }
        ...
        ChangeSet.prototype.findNewAddItemsPath = function (path) {
            return this.modifications.find(function (value, index) {
                return isEqual(path, value.path) && value.type === exports.ModifyType.Add;
            });
        };
        /**
    ...
    var EntityList = /** @class */ (function () {
        ...
        EntityList.prototype.setChanges = function (modinfo) {
            ...
            if (modinfo.type === exports.ModifyType.Add && modinfo.value[0] instanceof Entity) {
    ...
    var EntityCollection = /** @class */ (function () {
        ...
        EntityCollection.prototype.loadEntities = function (entities) {
            ...
            this.notifyCollectionChanged(new Modification(entities, exports.ModifyType.Load));
        };
        /**
         * 追加实体
         * @param entity 要追加的实体
        ...
        EntityCollection.prototype.addEntity = function (entity) {
            ...
            this.notifyCollectionChanged(new Modification([entity], exports.ModifyType.Add));
        };
        /**
         * 批量追加实体
     ...
     * UIState属性元数据装饰器工厂
     */
    var UIStatePropMeta = makePropDecorator(UISTATE_PROP_META, ɵ0$2);
     ...
     * 页面状态元数据装饰器工厂
     */
    var StatePropMeta = makePropDecorator(STATE_PROP_META, ɵ0$3);
     ...
     * 组件状态元数据工厂
     */
    var RenderStatePropMeta = makePropDecorator(RENDER_STATE_PROP_META, ɵ0$4);

    /**
     * 动作方法元数据名称
     */
    var ACTION_METHOD_META = 'ActionMethodMeta';
    var ɵ0$5 = function (action) { return action; };
    /**
     * 迁移动作元数据装饰工厂
     */
    var ActionMethodMeta = makePropDecorator(ACTION_METHOD_META, ɵ0$5);
    ...
    var ɵ0$6 = function (obj) { return obj; };
    /**
     * FormControl装饰器工厂
     */
    var FormControlPropMeta = makePropDecorator(FORM_CONTROL_PROP_META, ɵ0$6);
     ...
     * 命令装饰器工厂
     */
    var CommandMethodMeta = makePropDecorator(COMMAND_METHOD_META, ɵ0$7);
