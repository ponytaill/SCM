...
import { Subject, from, empty, EMPTY, of, isObservable, Observable, forkJoin, concat } from 'rxjs';
import { every, concatMap, switchMap, take, tap, map, filter, last, catchError, debounceTime, throwIfEmpty, delay, share } from 'rxjs/operators';
...
import { __spread, __assign, __extends, __values, __read } from 'tslib';
import { Injectable, Optional, LOCALE_ID, Inject, InjectionToken, Injector, ComponentFactoryResolver, ReflectiveInjector, ElementRef, InjectFlags, ApplicationRef, ChangeDetectorRef, NgModule } from '@angular/core';
...
var DialogService = /** @class */ (function () {
    ...
    DialogService.prototype.createModalComponentRef = function (config, component, uiStateObject) {
        ...
        if (frameContext && componentFactoryResolver) {
            ...
            var modalContentInjector = ReflectiveInjector.resolveAndCreate(__spread(this._providers), frameContext.injector);
            componentRef = contentCmptFactory.create(modalContentInjector);
            if (componentRef && componentRef.instance && componentRef.instance.viewModel && componentRef.instance.viewModel.uiState) {
                if (typeof uiStateObject === 'object' && Object.keys(uiStateObject).length) {
                    Object.keys(uiStateObject).forEach(function (item) {
