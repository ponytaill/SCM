...
export declare class DatagridComponent implements OnInit, OnDestroy, OnChanges, AfterContentInit, AfterViewInit, DoCheck {
    ...
    /** 最后一行的最后单元格回车处理事件 */
    lastCellEnterHandle: EventEmitter<{}>;
    /** 分组字段变化后 */
    ...
    columnsChanged(reloadData?: boolean, useColumnSettingWidth?: any): void;
    ...
    setColumnFormatter(field: string, formatter: any): void;
    updateColumnFormatterOptions(field: string, formatterOptions: any): void;
