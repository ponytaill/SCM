    ...
    */
            ...
            function (res) {
                ...
                if (!_this.shownOrgId || _this.shownOrgId === '*') {
                    ...
                    if (!_this.shownOrgPath) {
                        // for (const item of this.originalTreeData.data) {
                        //     if (item.orgId === this.shownOrgId) {
                        //         this.shownOrgPath = item.path;
                        //         break;
                        //     }
                        // }
                        /** @type {?} */
                ...
                // filterOrg.forEach(org => {
                //     org.selectable = true;
                //     if (!this._isInArray(org[this.orgIdField], this.orgIdField, this.originalTreeData.data)) {
                //         this.originalTreeData.data.push(org);
                //     }
                // });
                /** @type {?} */
    ...
    function () {
        ...
        function (res) {
            ...
            if (res && res.data) {
                _this.locationOrgList = _this.hlConfirmSearchOrg(res.data);
                if (_this.locationOrgList.length === 1) {
                    _this.searchOrgElementVisible = false;
                    _this.showUnSelectableInfo = false;
                    _this.locationOrg(_this.locationOrgList[0]);
    ...
    function (parentNode) {
        ...
        function (res) {
            if (res && res.data) {
                 ...
                 */
                function (item) {
                    if (!_this._isInArray(item[_this.orgIdField], _this.orgIdField, _this.originalTreeData.data)) {
                ...
                /** @type {?} */
                var nodes = _this.dealDataWhenExpandTreeNode(newDatas_1, res.curAbsUser.defaultOrgId == 'nullorg' ? '*' : res.curAbsUser.defaultOrgPath);
                _this.farrisTree.appendChildren(nodes, parentNode);
            }
        }));
    };
    ...
    function () {
        ...
        function (res) {
            ...
            if (currentOrgPath) {
                _this.treeListData = _this.dataToTree(res.data, 1, currentOrgPath);
            }
            else if (res.curAbsUser.defaultOrgId == 'nullorg') {
                // 需要区分是否为admin账户登录
                _this.treeListData = _this.dataToTree(res.data, 1, '*');
            }
            else {
    ...
    */
    ...
    function (size, token) {
        ...
        function (res) {
            ...
            _this.searchResultComponent.pageTotal = Math.ceil(res.totalCount / _this.pageSize);
    ...
    function (ids) {
        ...
        this.apiService.getPersonnelByUserIds(this.absUserOrgUrl, this.absOrgType, ids).subscribe((/**
         * @param {?} result
         * @return {?}
         */
        function (result) {
        ...
        if (!!this.shownOrgId && this.shownOrgId !== '*') {
            ...
            function (data) {
                if (data['orgId'] == _this.shownOrgId) {
                    _this.shownOrgPath = data.path;
                    for (var a = 0; a < (_this.shownOrgPath.length / 4); a++) {
                        pathList_3.push({ path: _this.shownOrgPath.substring(0, 4 * (a + 1)) });
                    }
                }
            }));
            orgArray.forEach((/**
            ...
            function (item) {
                ...
                else if (_this._isInArray(item['path'], 'path', pathList_3)) {
                    _this.showUnSelectableInfo = true;
                }
            }));
