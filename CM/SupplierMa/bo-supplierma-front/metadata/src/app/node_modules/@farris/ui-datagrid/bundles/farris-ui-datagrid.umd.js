(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('lodash-es'), require('bignumber.js'), require('@farris/ui-common'), require('@farris/ui-locale'), require('@farris/ui-common/types'), require('@angular/common'), require('perfect-scrollbar'), require('resize-observer-polyfill'), require('@farris/ui-filter-panel'), require('@angular/platform-browser'), require('@farris/ui-common/column'), require('@angular/forms'), require('@farris/ui-notify'), require('@farris/ui-pagination'), require('@farris/ui-filter'), require('@farris/smooth-dnd'), require('@farris/ui-context-menu')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-datagrid', ['exports', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators', 'lodash-es', 'bignumber.js', '@farris/ui-common', '@farris/ui-locale', '@farris/ui-common/types', '@angular/common', 'perfect-scrollbar', 'resize-observer-polyfill', '@farris/ui-filter-panel', '@angular/platform-browser', '@farris/ui-common/column', '@angular/forms', '@farris/ui-notify', '@farris/ui-pagination', '@farris/ui-filter', '@farris/smooth-dnd', '@farris/ui-context-menu'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['ui-datagrid'] = {}), global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators, global.lodashEs, global.bignumber_js, global.uiCommon, global.uiLocale, global.types, global.ng.common, global.PerfectScrollbar, global.ResizeObserver, global.uiFilterPanel, global.ng.platformBrowser, global.column, global.ng.forms, global.uiNotify, global.uiPagination, global.uiFilter, global.smoothDnd, global.uiContextMenu));
}(this, function (exports, core, http, rxjs, operators, lodashEs, bignumber_js, uiCommon, uiLocale, types, common, PerfectScrollbar, ResizeObserver, uiFilterPanel, platformBrowser, column, forms, uiNotify, uiPagination, uiFilter, smoothDnd, uiContextMenu) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var GRID_EDITORS = new core.InjectionToken('Farris DataGrid Editors.');
    /** @type {?} */
    var GRID_VALIDATORS = new core.InjectionToken('Farris DataGrid Validators.');
    /** @type {?} */
    var GRID_FILTER_ROW = new core.InjectionToken('Farris DataGrid Filter-Row Component.');
    /** @type {?} */
    var GRID_SETTINGS_PANEL = new core.InjectionToken('Farris DataGrid Setting Panel Component.');
    /** @type {?} */
    var GRID_SETTINGS_SERVICE = new core.InjectionToken('Farris DataGrid Setting Service.');
    /** @type {?} */
    var GRID_SETTINGS_HTTP = new core.InjectionToken(' Datagrid Settings HttpClient.');
    /** @type {?} */
    ...
    var DatagridColumnsHelper = /** @class */ (function () {
        ...
        function (col) {
            if (typeof col.visible === 'function') {
                /** @type {?} */
                var visibleAsObservable = rxjs.bindCallback(col.visible);
                return visibleAsObservable();
            }
            return rxjs.of(col.visible);
        };
        /**
         * @param {?} col
         * @param {?} allCols
    ...
    var DatagridFacadeService = /** @class */ (function () {
        function DatagridFacadeService(http) {
            ...
            this.store = new rxjs.BehaviorSubject(null);
            this.virtualRowSubject = new rxjs.BehaviorSubject(null);
            this.gridSizeSubject = new rxjs.Subject();
            this.errorSubject = new rxjs.Subject();
            this.selectRowSubject = new rxjs.Subject();
            this.unSelectRowSubject = new rxjs.Subject();
            this.columnResizeSubject = new rxjs.Subject();
            this.clearSelectionSubject = new rxjs.Subject();
            this.checkRowSubject = new rxjs.Subject();
            this.unCheckRowSubject = new rxjs.Subject();
            this.clearCheckedsSubject = new rxjs.Subject();
            this.clearAllSubject = new rxjs.Subject();
            this.checkAllSubject = new rxjs.Subject();
            this.unCheckAllSubject = new rxjs.Subject();
            this.selectAllSubject = new rxjs.Subject();
            this.selectCellSubject = new rxjs.Subject();
            ...
            this.clientSort$ = new core.EventEmitter();
            this.rowAppend$ = new core.EventEmitter();
            this.rowUpdate$ = new core.EventEmitter();
            this.rowDelete$ = new core.EventEmitter();
            this.updateCheckboxState$ = new core.EventEmitter();
            this.state$ = this.store.asObservable().pipe(operators.filter((/**
             * @param {?} state
             * @return {?}
             */
            function (state) { return state; })));
            this.columnGroup$ = this.gridSizeSubject.asObservable().pipe(operators.filter((/**
             * @param {?} state
             * @return {?}
             */
            function (state) { return state; })), operators.map((/**
             * @param {?} state
             * @return {?}
             */
            function (state) { return state.columnsGroup; })), operators.switchMap((/**
             * @param {?} colgroup
             * @return {?}
             */
            function (colgroup) {
                return rxjs.of(colgroup);
            })), operators.distinctUntilChanged());
            this.gridSize$ = this.gridSizeSubject.asObservable().pipe(operators.filter((/**
             * @param {?} state
             * @return {?}
             */
            function (state) { return state; })), operators.map((/**
            ...
            this.data$ = this.virtualRowSubject.pipe(operators.filter((/**
             * @param {?} vs
             * @return {?}
             */
            function (vs) { return vs; })), operators.switchMap((/**
             * @param {?} vs
             * @return {?}
             */
            function (vs) {
            ...
            this._state = lodashEs.cloneDeep(initDataGridState);
        }
        /**
         * @param {?} scrolltop
        ...
        function (scrolltop) {
            ...
            if (this._state.flatColumns && this._state.flatColumns.length) {
                ...
                if (this._state.groupRows) {
                    // 行分组数据处理
                    /** @type {?} */
                    var groupRows = this.groupRows2(lodashEs.cloneDeep(data));
                    virtual.virtualRows = groupRows;
                }
            }
        ...
        function (state) {
            ...
            this._state.originalData = lodashEs.cloneDeep(this._state.data);
            this.initColumns();
        ...
        function (rowId) {
            ...
            if (origData) {
                ...
                this.getCurrentRow().data = lodashEs.cloneDeep(origRowData);
         ...
         */
        function () {
            return lodashEs.flatten(this._state.columns);
        };
        /**
         * @param {?} fieldName
         * @return {?}
        ...
        function (rowid) {
            ...
            if (changes) {
                if (!rowid) {
                    this._state.data = lodashEs.cloneDeep(this._state.originalData);
                    ...
                    if (rowChanges) {
                        ...
                        function (r) {
                            if (_this.primaryId(r) === rowid) {
                                r = lodashEs.cloneDeep(orgiRow_1);
                            }
                        }));
                    }
                }
        ...
        function () {
            /** @type {?} */
            var data = lodashEs.cloneDeep(this._state.data);
            this.loadData(data);
        };
        //#endregion
        /**
        ...
        function (data) {
            ...
            /** @type {?} */
            var columns = lodashEs.flatten(this._state.columns).filter((/**
             * @param {?} col
             * @return {?}
             */
        ...
        function (groupRows, initLevel, parent) {
            ...
            function (k, m) {
                ...
                if (lodashEs.isPlainObject(items)) {
                    /** @type {?} */
        ...
        function (data, typ, col) {
            ...
            switch (typ) {
                case CalculationType.sum:
                    ...
                    val = bignumber_js.BigNumber.sum.apply(null, arr).toFixed();
                    break;
                case CalculationType.max:
                    // const maxObj = maxBy(data, (o) => Utils.getValue(field, o));
                    // val = Utils.getValue(field, maxObj);
                    val = bignumber_js.BigNumber.max.apply(null, arr).toFixed();
                    break;
                case CalculationType.min:
                    // const minObj = minBy(data, (o) => Utils.getValue(field, o));
                    // val = Utils.getValue(field, minObj);
                    val = bignumber_js.BigNumber.min.apply(null, arr).toFixed();
                    break;
                case CalculationType.average:
                    // val = meanBy(data, (o) => Utils.getValue(field, o));
                    val = bignumber_js.BigNumber.sum.apply(null, arr).div(arr.length).toFixed();
                    break;
            ...
            if (opts.columns && opts.columns[0]) {
                ...
                function (n) {
                    return {
                        ...
                        align: n.align,
                        visible: n.visible,
                        footer: lodashEs.cloneDeep(n.footer || {}),
                        groupFooter: lodashEs.cloneDeep(n.groupFooter || {})
                    };
                }));
            }
        };
    ...
    var DatagridService = /** @class */ (function () {
        function DatagridService() {
            this.scorllSubject = new rxjs.Subject();
            this.scrollX = new rxjs.BehaviorSubject(0);
            this.rowHoverSubject = new rxjs.Subject();
            this.rowSelectSubject = new rxjs.Subject();
            this.dataSourceChangedSubject = new rxjs.Subject();
            /**
             * 编辑单元格
             */
            this.editCellSubject = new rxjs.Subject();
            /**
             * 选中单元格
             */
            this.selectCellSubject = new rxjs.Subject();
             ...
             * 结束单元编辑
             */
            this.endCellEdit = new rxjs.Subject();
            this.changeCheckedRows = new rxjs.Subject();
            /**
             * 结束行编辑
             */
            // private endRowEdit = new BehaviorSubject(true);
            this.scorll$ = this.scorllSubject.asObservable();
            this.scrollX$ = this.scorll$.pipe(operators.filter((/**
             * @param {?} p
             * @return {?}
             */
            function (p) { return p.type === 'psScrollX'; })), operators.map((/**
             * @param {?} t
             * @return {?}
             */
            function (t) { return t.x; })), operators.debounceTime(50));
            this.scrollY$ = this.scorll$.pipe(operators.filter((/**
             * @param {?} p
             * @return {?}
             */
            function (p) { return p.type === 'psScrollY'; })), operators.map((/**
             * @param {?} t
             * @return {?}
             */
            function (t) { return t.x; })), operators.debounceTime(50));
            ...
            this.updateEmptyStyle$ = new core.EventEmitter();
            this.showGridHeader = new core.EventEmitter();
            // 取消全选
            this.uncheckAll = new core.EventEmitter();
            // 全部选中
            this.checkAll = new core.EventEmitter();
            this.columnResized = new core.EventEmitter();
            this.rowHeightChanged = new core.EventEmitter();
            this.loadVirtualData = new core.EventEmitter();
            /**
             * 显示固定列隐影
             */
            this.showFixedShadow = new core.EventEmitter();
            // public endRowEdit$ = this.endRowEdit.asObservable();
            this.setSelecedRow = new core.EventEmitter();
            this.setCheckedRows = new core.EventEmitter();
            this.scrollToCurrentRow = new core.EventEmitter();
            this.columnsChanged = new core.EventEmitter();
            this.cellContentWrapChanged = new core.EventEmitter();
            ...
            this.toggleFilterRow = new core.EventEmitter();
            this.refreshFooterData = new core.EventEmitter();
            this.disableHeader = new core.EventEmitter();
            /**
             * 更新全选复选框状态
             */
            this.changeCheckAllStatus = new core.EventEmitter();
            this.setScrollbarPosition = new core.EventEmitter();
            this.smartFilterBarExpand = new core.EventEmitter();
            this.smartFilterDataChange = new core.EventEmitter();
            this.scrollbarUpdate = new core.EventEmitter();
            this.footerPositionChanged = new core.EventEmitter();
            this.styleElement = null;
            this.commonUtils = null;
            this.idService = null;
            // 单元格编辑器创建完成
            this.cellEditorCreated = new core.EventEmitter();
            // 单元格编辑器销毁
            this.cellEditorDestory = new core.EventEmitter();
            // 焦点行切换
            this.focusRowChanged = new core.EventEmitter();
            this.groupBy = (/**
             * @param {?} arr
             * @param {?} fn
             * @return {?}
        ...
        function (gridID) {
            ...
            if (!this.idService) {
                this.idService = new uiCommon.IdService();
            }
     ...
     */
    /** @type {?} */
    var DATAGRID_REST_SERVICEE = new core.InjectionToken('DataGrid Request Data Service.');
    /**
     * @abstract
     */
    var   /**
    ...
    var DatagridFilterService = /** @class */ (function () {
        ...
        function (fieldDataValue, operator, targetValue) {
            ...
            switch (op) {
                ...
                case types.Compare.LessOrEqual:
                    return fieldDataValue <= targetValue;
                case types.Compare.Like:
                    return ('' + fieldDataValue).toLowerCase().indexOf(targetValue.toLowerCase()) > -1;
                case types.Compare.NotLike:
                    return ('' + fieldDataValue).toLowerCase().indexOf(targetValue.toLowerCase()) === -1;
                case types.Compare.In:
        ...
        function (conditions) {
            ...
            function (c, r) {
                ...
                if (filter.operator1 == types.Compare.In) {
                    /** @type {?} */
                    ...
                    if (filter.operator1 == types.Compare.Equal && Array.isArray(filter.value1)) {
                            ...
                            if (conditionVal.value2) {
                                ...
                                if (conditionVal.operator2) {
                                    ...
                                    if (op2 === 1001 || op2 === 1002) {
                                        ...
                                        /** @type {?} */
                                        var obj2 = { filterField: field, value: '', lbracket: '', rbracket: ')', relation: 1, compare: 0 };
                                        obj2.compare = op2 === 1001 ? types.Compare.Equal : types.Compare.NotEqual;
                                        obj2.value = '';
                                        filterArr.push(obj2);
                                    }
                                }
                ...
                if (col && col.filter && col.filter.type === ColumnFilterType.enum) {
                    if (Array.isArray(filter.value) && filter.value.length) {
                        if (filter.value.length === 1) {
                            filter.compare = types.Compare.Equal;
     ...
     */
    /** @type {?} */
    var SCROLLBAR_CONFIG = new core.InjectionToken('PERFECT_SCROLLBAR_CONFIG');
    ...
    var ScrollbarDirective = /** @class */ (function () {
                ...
                function () {
                    ...
                    function (eventName) {
                        ...
                        if (eventName.indexOf('X') > -1 || eventName.indexOf('Left') > -1 || eventName.indexOf('Right') > -1) {
                            rxjs.fromEvent(_this.elementRef.nativeElement, eventType).subscribe((/**
                             * @param {?} event
                             * @return {?}
                             */
                            function (event) {
                            ...
                            rxjs.fromEvent(_this.elementRef.nativeElement, eventType).pipe(operators.takeUntil(_this.ngDestroy)).pipe(
                            // debounceTime(20),
                            // throttle(ev => interval(20)),
                            operators.auditTime(20))
                                .subscribe((/**
                             * @param {?} event
                             * @return {?}
                             */
        ...
        ScrollbarDirective.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Optional }, { type: core.Inject, args: [SCROLLBAR_CONFIG,] }] }
        ]; };
        ScrollbarDirective.propDecorators = {
            disabled: [{ type: core.Input }],
            config: [{ type: core.Input, args: ['scrollbar',] }],
    ...
    var ScrollbarComponent = /** @class */ (function () {
        ...
        function () {
            ...
            if (common.isPlatformBrowser(this.platformId)) {
                this.stateUpdate
                    .pipe(operators.takeUntil(this.ngDestroy))
        ...
        ScrollbarComponent.propDecorators = {
            ...
            psXReachEnd: [{ type: core.Output }],
            psXReachStart: [{ type: core.Output }],
            directiveRef: [{ type: core.ViewChild, args: [ScrollbarDirective,] }]
        };
    ...
    var ScrollbarArrowsComponent = /** @class */ (function () {
        function ScrollbarArrowsComponent() {
            ...
            this.hasXScrollbar = new core.EventEmitter();
            this.hasYScrollbar = new core.EventEmitter();
            this.scrollMoveTo = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        ScrollbarArrowsComponent.propDecorators = {
            reachX: [{ type: core.Input }],
            reachY: [{ type: core.Input }],
            scrollbarXActive: [{ type: core.Input }],
            scrollbarYActive: [{ type: core.Input }],
            hasXScrollbar: [{ type: core.Output }],
            hasYScrollbar: [{ type: core.Output }],
            scrollMoveTo: [{ type: core.Output }]
        };
    ...
    var ScrollbarModule = /** @class */ (function () {
        ...
        ScrollbarModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: [
                            common.CommonModule, ScrollbarComponent, ScrollbarDirective,
                            ScrollbarArrowsComponent,
                        ]
                    },] }
        ];
    ...
    var DatagridColumnDirective = /** @class */ (function () {
        ...
        DatagridColumnDirective.propDecorators = {
            ...
            halign: [{ type: core.Input }],
            align: [{ type: core.Input }],
            formatter: [{ type: core.Input }],
            readonly: [{ type: core.Input }],
            editable: [{ type: core.Input }],
            editor: [{ type: core.ContentChild, args: [DatagridCellEditorDirective,] }]
        };
    ...
    var SmartFilterToolbarComponent = /** @class */ (function () {
        function SmartFilterToolbarComponent(el, render, inject) {
            ...
            this.removeFilter = new core.EventEmitter();
        ...
        function () {
            ...
            this.dg.dgs.clearFilter.pipe(operators.takeUntil(this.destory$)).subscribe((/**
             * @return {?}
             */
            function () {
        ...
        SmartFilterToolbarComponent.propDecorators = {
            ...
            removeFilter: [{ type: core.Output }],
            filterChange: [{ type: core.Output }],
            resize: [{ type: core.Output }],
            filtebar: [{ type: core.ViewChild, args: ['farrisFilter',] }]
        };
    ...
    var DatagridSmartFilterService = /** @class */ (function () {
        function DatagridSmartFilterService() {
            ...
            this.removeFilter = new rxjs.Subject();
            this.clearAllFilter = new rxjs.Subject();
        }
        /**
         * @param {?} col
         * @return {?}
    ...
    var SelectionModeService = /** @class */ (function () {
        ...
        function (param) {
            ...
            if (this.dgRef && this.dgRef.selectionMode === 'default') {
                ...
                this.dgRef.beforeSelect(param).pipe(operators.delay(100)).subscribe((/**
                 * @param {?} canSelect
                 * @return {?}
                 */
                function (canSelect) {
    ...
    var DatagridComponent = /** @class */ (function () {
        function DatagridComponent(cd, el, inject, zone, dfs, dgs, app, domSanitizer, render2) {
             ...
             */
            this._groupField = '';
            this.groupFields$ = new rxjs.BehaviorSubject([]);
            /**
             * 显示分组列
             */
            ...
            this.selectValueChange = new core.EventEmitter();
            this.checkValuesChange = new core.EventEmitter();
            this.selectValuesChange = new core.EventEmitter();
            this.beginEdit = new core.EventEmitter();
            this.endEdit = new core.EventEmitter();
            this.cancelEdited = new core.EventEmitter();
            this.scrollY = new core.EventEmitter();
            this.pageSizeChanged = new core.EventEmitter();
            this.pageChanged = new core.EventEmitter();
            this.loadSuccess = new core.EventEmitter();
             ...
             * 单元格点击前事件
             */
            this.beforeClickCell = new core.EventEmitter();
            this.dblclickRow = new core.EventEmitter();
            this.selectChanged = new core.EventEmitter();
            this.unSelect = new core.EventEmitter();
            this.selectAll = new core.EventEmitter();
            this.unSelectAll = new core.EventEmitter();
            /**
             * 异步请求虚拟加载
             */
            this.scrollYLoad = new core.EventEmitter();
            this.checked = new core.EventEmitter();
            this.unChecked = new core.EventEmitter();
            this.checkAll = new core.EventEmitter();
            this.unCheckAll = new core.EventEmitter();
            this.checkedChange = new core.EventEmitter();
            this.columnSorted = new core.EventEmitter();
            this.rowClick = new core.EventEmitter();
            this.rowAppended = new core.EventEmitter();
            this.rowDeleted = new core.EventEmitter();
            this.rowUpdated = new core.EventEmitter();
            this.dataChange = new core.EventEmitter();
            /**
             * 最后一行的最后单元格回车处理事件
             */
            this.lastCellEnterHandle = new core.EventEmitter();
            /**
             * 分组字段变化后
             */
            this.groupFieldChange = new core.EventEmitter();
            /**
             * 拖动列改变列显示位置后触发
             */
            ...
            function (event) {
                ...
                if (!event.target.closest('.f-datagrid')) {
                    ...
                    if (event.target.closest('.f-datagrid').id === _this.id) {
                        return;
                    }
                }
            ...
            this.localeService = this.inject.get(uiLocale.LocaleService);
            this.restService = this.inject.get(DATAGRID_REST_SERVICEE, null);
            this.colFormatSer = this.inject.get(column.ColumnFormatService);
            this.commonUtils = this.inject.get(uiCommon.CommonUtils, null);
            this.clientFilterService = new DatagridFilterService(dfs, this.localeService, inject);
            this.farrisInstances = this.inject.get(uiCommon.FarrisComponentInstanceService, null);
            this.debugSer = this.inject.get(uiCommon.DebugService, null);
            if (!this.debugSer) {
            ...
            this.idService = this.inject.get(uiCommon.IdService, null);
            ...
            /** @type {?} */
            var columnGroupSubscription = this.dfs.columnGroup$.pipe(operators.debounceTime(60)).subscribe((/**
             * @param {?} cg
             * @return {?}
             */
            function (cg) {
        ...
        function () {
            if ((this.showFooter || this.pagerContentTemplate) && this.footerDataFrom === 'client') {
                this.footerData = rxjs.of(this.dfs.getFooterData(this.data));
            }
        };
        //#region Ng Event
        //#region Ng Event
        ...
        function () {
            var _this = this;
            this.flatColumns = lodashEs.flatten(this.columns).filter((/**
             * @param {?} col
             * @return {?}
             */
        ...
        function () {
            if (this.isMultiHeader()) {
                /** @type {?} */
                var allCols = lodashEs.flatten(this.columns);
            ...
            if (this.showHeader) {
                if (!this.headerWrap) {
                    ...
                    if (gridHeaderEl) {
                        ...
                        /** @type {?} */
                        var h = Math.max.apply(Math, __spread(Array.from(trs).map((/**
                         * @param {?} n
                         * @return {?}
                         */
        ...
        function (fields, visible) {
            ...
            if (!this.isMultiHeader()) {
                ...
                // 多表头
                /** @type {?} */
                var allCols_1 = lodashEs.flatten(this.columns);
                allCols_1.forEach((/**
                 * @param {?} p
                 * @return {?}
                 */
        ...
        DatagridComponent.propDecorators = {
            fast: [{ type: core.Input }],
            pos: [{ type: core.HostBinding, args: ['style.position',] }],
            hostCls: [{ type: core.HostBinding, args: ['class.f-datagrid-full',] }],
            autoHeightCls: [{ type: core.HostBinding, args: ['class.f-datagrid-auto-height',] }],
            useThemes: [{ type: core.Input }],
            id: [{ type: core.Input }],
            useHtmlTable: [{ type: core.Input }],
            ...
            headerWrap: [{ type: core.Input }],
            showFooter: [{ type: core.Input }],
            footerHeight: [{ type: core.Input }],
            footerDataFrom: [{ type: core.Input }],
            footerTemplate: [{ type: core.Input }],
            footerPosition: [{ type: core.Input }],
            footerStyler: [{ type: core.Input }],
            rowHeight: [{ type: core.Input }],
            sizeType: [{ type: core.Input }],
            fit: [{ type: core.Input }],
            fitColumns: [{ type: core.Input }],
            autoFitColumns: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            scrollBarShowMode: [{ type: core.Input }],
            scrollBarOptions: [{ type: core.Input }],
            showScrollArrow: [{ type: core.Input }],
            resizeColumn: [{ type: core.Input }],
            showLineNumber: [{ type: core.Input }],
            lineNumberTitle: [{ type: core.Input }],
            lineNumberWidth: [{ type: core.Input }],
            rowHover: [{ type: core.Input }],
            clickToEdit: [{ type: core.Input }],
            lockPagination: [{ type: core.Input }],
            pagination: [{ type: core.Input }],
            pagerContentTemplate: [{ type: core.Input }],
            pagerPos: [{ type: core.Input }],
            pagerViewMode: [{ type: core.Input }],
            pagerOnServer: [{ type: core.Input }],
            pageList: [{ type: core.Input }],
            pageIndex: [{ type: core.Input }],
            pageSize: [{ type: core.Input }],
            pagerHeight: [{ type: core.Input }],
            showPageList: [{ type: core.Input }],
            showPageInfo: [{ type: core.Input }],
            showPageNumber: [{ type: core.Input }],
            pagerLabelSize: [{ type: core.Input }],
            showGotoInput: [{ type: core.Input }],
            enableMorePageSelect: [{ type: core.Input }],
            showSelectedList: [{ type: core.Input }],
            selectedItemFormatter: [{ type: core.Input }],
            cellTipTimer: [{ type: core.Input }],
            controlPaginationState: [{ type: core.Input }],
            total: [{ type: core.Input }],
            enableSelectRow: [{ type: core.Input }],
            multiSelect: [{ type: core.Input }],
            showCheckbox: [{ type: core.Input }],
            showAllCheckbox: [{ type: core.Input }],
            ...
            emptyDataHeight: [{ type: core.Input }],
            ...
            endEditByInvalid: [{ type: core.Input }],
            columns: [{ type: core.Input }],
            fields: [{ type: core.Input }],
            nowrap: [{ type: core.Input }],
            virtualized: [{ type: core.Input }],
            virtualizedAsyncLoad: [{ type: core.Input }],
            rowStyler: [{ type: core.Input }],
            editMode: [{ type: core.Input }],
            editable: [{ type: core.Input }],
            enableEditCellStyle: [{ type: core.Input }],
            selectOnEditing: [{ type: core.Input }],
            editorHeight: [{ type: core.Input }],
            remoteSort: [{ type: core.Input }],
            sortName: [{ type: core.Input }],
            sortOrder: [{ type: core.Input }],
            multiSort: [{ type: core.Input }],
            hoverRowCls: [{ type: core.Input }],
            enableDragColumn: [{ type: core.Input }],
            rowGroupPanelHeight: [{ type: core.Input }],
            groupRows: [{ type: core.Input }],
            groupFooter: [{ type: core.Input }],
            expandGroupRows: [{ type: core.Input }],
            groupFooterStyler: [{ type: core.Input }],
            groupSummaryPosition: [{ type: core.Input }],
            groupCellColSpan: [{ type: core.Input }],
            groupField: [{ type: core.Input }],
            showGroupColumn: [{ type: core.Input }],
            groupFormatter: [{ type: core.Input }],
            groupStyler: [{ type: core.Input }],
            showRowGroupPanel: [{ type: core.Input }],
            AutoColumnWidthUseDblclick: [{ type: core.Input }],
            disableRow: [{ type: core.Input }],
            useDefaultFilter: [{ type: core.Input }],
            enableSmartFilter: [{ type: core.Input }],
            enableFilterRow: [{ type: core.Input }],
            remoteFilter: [{ type: core.Input }],
            showFilterBar: [{ type: core.Input }],
            filterBarHeight: [{ type: core.Input }],
            filterRowHeight: [{ type: core.Input }],
            conditions: [{ type: core.Input }],
            selectValue: [{ type: core.Input }],
            checkValues: [{ type: core.Input }],
            selectValues: [{ type: core.Input }],
            mergeCell: [{ type: core.Input }],
            mergeFields: [{ type: core.Input }],
            enableClientSortForMergeCell: [{ type: core.Input }],
            useControlPanel: [{ type: core.Input }],
            enableSimpleMode: [{ type: core.Input }],
            controlPanelMode: [{ type: core.Input }],
            enableScheme: [{ type: core.Input }],
            defaultSchemeName: [{ type: core.Input }],
            stopPropagation: [{ type: core.Input }],
            closeOtherGridEditor: [{ type: core.Input }],
            clearSelectionsWhenDataIsEmpty: [{ type: core.Input }],
            enableContextMenu: [{ type: core.Input }],
            contextMenus: [{ type: core.Input }],
            selectValueChange: [{ type: core.Output }],
            checkValuesChange: [{ type: core.Output }],
            selectValuesChange: [{ type: core.Output }],
            beforeEdit: [{ type: core.Input }],
            beginEdit: [{ type: core.Output }],
            afterEdit: [{ type: core.Input }],
            endEdit: [{ type: core.Output }],
            cancelEdited: [{ type: core.Output }],
            scrollY: [{ type: core.Output }],
            ...
            beforeUnselect: [{ type: core.Input }],
            beforeCheck: [{ type: core.Input }],
            beforeUncheck: [{ type: core.Input }],
            beforeSortColumn: [{ type: core.Input }],
            enableHighlightCell: [{ type: core.Input }],
            checkedRowsDataFromSource: [{ type: core.Input }],
            editcellWhenTabKeydwon: [{ type: core.Input }],
            beforeClickCell: [{ type: core.Output }],
            dblclickRow: [{ type: core.Output }],
            selectChanged: [{ type: core.Output }],
            unSelect: [{ type: core.Output }],
            selectAll: [{ type: core.Output }],
            unSelectAll: [{ type: core.Output }],
            scrollYLoad: [{ type: core.Output }],
            checked: [{ type: core.Output }],
            unChecked: [{ type: core.Output }],
            checkAll: [{ type: core.Output }],
            unCheckAll: [{ type: core.Output }],
            checkedChange: [{ type: core.Output }],
            columnSorted: [{ type: core.Output }],
            rowClick: [{ type: core.Output }],
            rowAppended: [{ type: core.Output }],
            rowDeleted: [{ type: core.Output }],
            rowUpdated: [{ type: core.Output }],
            dataChange: [{ type: core.Output }],
            lastCellEnterHandle: [{ type: core.Output }],
            groupFieldChange: [{ type: core.Output }],
            columnMoved: [{ type: core.Output }],
            cellClick: [{ type: core.Output }],
            dgColumns: [{ type: core.ContentChildren, args: [DatagridColumnDirective,] }],
            dgPager: [{ type: core.ViewChild, args: ['dgPager',] }],
            resizeProxy: [{ type: core.ViewChild, args: ['resizeProxy',] }],
            resizeProxyBg: [{ type: core.ViewChild, args: ['resizeProxyBg',] }],
            dgContainer: [{ type: core.ViewChild, args: ['datagridContainer',] }],
            longTextArea: [{ type: core.ViewChild, args: ['longTextArea',] }],
            smartFilterToolbar: [{ type: core.ViewChild, args: ['smartfiltertoolbar',] }],
    ...
    var DatagridSmartFilterComponent = /** @class */ (function () {
        ...
        function () {
            ...
            return lodashEs.cloneDeep(this.filterData);
        };
        /**
         * @private
         * @param {?} $event
        ...
        DatagridSmartFilterComponent.ctorParameters = function () { return [
            ...
            { type: DatagridComponent, decorators: [{ type: core.Optional }] }
        ]; };
        DatagridSmartFilterComponent.propDecorators = {
            column: [{ type: core.Input }],
            filterData: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            sortTmp: [{ type: core.ViewChild, args: ['sort',] }],
            onClick: [{ type: core.HostListener, args: ['click', ['$event'],] }]
        };
    ...
    var FormatCellDataPipe = /** @class */ (function () {
        function FormatCellDataPipe(cfs, injector) {
            ...
            this.localeId = this.injector.get(core.LOCALE_ID);
        }
        /**
         * @param {?} col
         * @param {?} rowData
    ...
    */
        ...
        function () {
            ...
            if (!this.elRef) {
                this.elRef = this.injector.get(core.ElementRef, null);
            }
        };
        /**
         * @param {?} col
    ...
    var DatagridBodyComponent = /** @class */ (function () {
        function DatagridBodyComponent(injector, app, dg, cd, el) {
            ...
            function (e) {
                ...
                if (contextMenuDom) {
                    ...
                    if (contextMenuDom.className.indexOf('f-datagrid-group-row') === -1 && contextMenuDom.className.indexOf('f-datagrid-group-footer') === -1) {
                        ...
                        return rxjs.of({ show: true, data: { data: rowData.data, grid: _this.dg }, focusTargetWidth: focusTargetWidth });
                    }
                }
                return rxjs.of({ show: false });
            });
            ...
            /** @type {?} */
            var columnFormatService = this.injector.get(column.ColumnFormatService);
        ...
        function () {
            ...
            /** @type {?} */
            var s5 = this.dg.dgs.columnsChanged.pipe(operators.delay(100)).subscribe((/**
             * @param {?} e
             * @return {?}
             */
            function (e) {
        ...
        function () {
            var _this = this;
            this.destroySubscriptions();
            this.gridSizeSubscribe = this.dfs.gridSize$.pipe(operators.takeUntil(this.destroy$)).pipe(operators.debounceTime(50)).subscribe((/**
             * @param {?} state
             * @return {?}
             */
            function (state) {
            ...
            this.dgs.columnResized.pipe(operators.delay(100)).subscribe((/**
             * @param {?} e
             * @return {?}
             */
            function (e) {
            ...
            this.dgs.cellContentWrapChanged.pipe(operators.delay(100)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.updateRowHeight();
        ...
        DatagridBodyComponent.propDecorators = {
            ...
            columnsGroup: [{ type: core.Input }],
            topHideHeight: [{ type: core.Input }],
            bottomHideHeight: [{ type: core.Input }],
            startRowIndex: [{ type: core.Input }],
            data: [{ type: core.Input }],
            dataChange: [{ type: core.Output }],
            scrollBarMode: [{ type: core.Input }],
            contextMenuItems: [{ type: core.Input }],
            checkedRows: [{ type: core.Input }],
            fast: [{ type: core.Input }],
            ps: [{ type: core.ViewChild, args: ['ps',] }],
            tableRowsCmp: [{ type: core.ViewChild, args: ['mainRows',] }],
            rightRowsCmp: [{ type: core.ViewChild, args: ['rightRows',] }],
            fixedLeftEl: [{ type: core.ViewChild, args: ['fixedLeft',] }],
            fixedRightEl: [{ type: core.ViewChild, args: ['fixedRight',] }],
            mainArea: [{ type: core.ViewChild, args: ['main',] }],
            viewScrollContainer: [{ type: core.ViewChild, args: ['viewScrollContainer',] }]
        };
    ...
    var DatagridRowHoverDirective = /** @class */ (function () {
        ...
        DatagridRowHoverDirective.ctorParameters = function () { return [
            { type: DatagridComponent, decorators: [{ type: core.Inject, args: [core.forwardRef((/**
                             * @return {?}
                             */
                            function () { return DatagridComponent; })),] }] },
            { type: DatagridBodyComponent, decorators: [{ type: core.Inject, args: [core.forwardRef((/**
                             * @return {?}
                             */
        ...
        DatagridRowHoverDirective.propDecorators = {
            ...
            rowData: [{ type: core.Input, args: ['row-hover',] }]
        };
    ...
    var DatagridRowDirective = /** @class */ (function () {
        ...
        function () {
            var _this = this;
            this.datasourceChangedSubscription = this.dg.dgs.onDataSourceChange.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.renderCustomStyle();
            }));
            this.columnsChangedSubscription = this.dg.dgs.columnsChanged.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.createControl();
            ...
            /** @type {?} */
            var s$ = this.dg.dfs.rowUpdate$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} row
             * @return {?}
             */
            function (row) {
            ...
            /** @type {?} */
            var s1$ = this.dg.dgs.updateEmptyStyle$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
            ...
            this.subscriptions.push(s1$);
            /** @type {?} */
            var s2$ = this.dg.dfs.selectRow$.pipe(operators.takeUntil(this.destroy$)).pipe(operators.filter((/**
             * @param {?} r
             * @return {?}
             */
            function (r) {
        ...
        function (event) {
            ...
            /** @type {?} */
            var useNewSelectionMode = this.dg.sms.beforRowClick(__assign({}, beforEventParam, { e: event, id: rowId, dr: this }));
            ...
            if (!this.dfs.isRowSelected(rowId)) {
                ...
                if (!canendedit || canendedit.canEnd) {
                    this.dg.beforeSelect(beforEventParam).pipe(operators.takeUntil(this.destroy$)).pipe(operators.delay(100)).subscribe((/**
                     * @param {?} canSelect
                     * @return {?}
                     */
                    function (canSelect) {
                ...
                if (!this.dg.keepSelect) {
                    this.dg.beforeUnselect(beforEventParam).pipe(operators.takeUntil(this.destroy$)).subscribe((/**
                     * @param {?} canUnselect
                     * @return {?}
                     */
        ...
        function (validators) {
            ...
            if (validators && validators.length) {
                ...
                function (v) {
                    ...
                    switch (v.type) {
                        case 'required':
                            validation = forms.Validators.required;
                            break;
                        case 'min':
                            validation = forms.Validators.min(v.value);
                            break;
                        case 'max':
                            validation = forms.Validators.max(v.value);
                            break;
                        case 'minLength':
                            validation = forms.Validators.minLength(v.value);
                            break;
                        case 'maxLength':
                            validation = forms.Validators.maxLength(v.value);
                            break;
                        case 'email':
                            validation = forms.Validators.email;
                            break;
                        case 'requiredTrue':
                            validation = forms.Validators.requiredTrue;
                            break;
                        case 'pattern':
                            validation = forms.Validators.pattern(v.value);
                            break;
                    }
                    if (validation) {
        ...
        DatagridRowDirective.ctorParameters = function () { return [
            ...
            { type: core.ElementRef },
            { type: core.Renderer2 },
            { type: DatagridRowHoverDirective, decorators: [{ type: core.Optional }, { type: core.Self }] }
        ]; };
        DatagridRowDirective.propDecorators = {
            editable: [{ type: core.Input }],
            rowData: [{ type: core.Input, args: ['grid-row',] }],
            rowIndex: [{ type: core.Input }],
            clickHandler: [{ type: core.Output }],
            cells: [{ type: core.ContentChildren, args: [core.forwardRef((/**
                         * @return {?}
                         */
                        function () { return DatagridCellComponent; })), { descendants: true },] }],
            onRowClick: [{ type: core.HostListener, args: ['click', ['$event'],] }]
        };
    ...
    var GridCellEditorDirective = /** @class */ (function () {
        function GridCellEditorDirective(resolver, container, app, fb, dg) {
            ...
            this.cfs = null;
            this.timer = null;
            this.cfs = this.dg.inject.get(column.ColumnFormatService);
        }
        /**
         * @return {?}
         */
    ...
    var DatagridCellComponent = /** @class */ (function () {
        ...
        DatagridCellComponent.ctorParameters = function () { return [
            { type: DatagridComponent, decorators: [{ type: core.Inject, args: [core.forwardRef((/**
                             ...
                             */
                            function () { return DatagridComponent; })),] }] },
            { type: DatagridRowDirective, decorators: [{ type: core.Inject, args: [core.forwardRef((/**
                             * @return {?}
                             */
        ...
        DatagridCellComponent.propDecorators = {
            ...
            rowData: [{ type: core.Input }],
            rowIndex: [{ type: core.Input }],
            lastColumn: [{ type: core.Input }],
            isEditing: [{ type: core.Input }],
            isSelected: [{ type: core.Input }],
            cellContainer: [{ type: core.ViewChild, args: ['cellContainer',] }],
            cellTemplateVcr: [{ type: core.ViewChild, args: ['cellTemplate', { read: core.ViewContainerRef },] }],
            cellEditorTemplate: [{ type: core.ViewChild, args: ['cellEditorTemplate', { read: core.ViewContainerRef },] }],
            cellEditor: [{ type: core.ViewChild, args: [GridCellEditorDirective,] }],
            cellClick: [{ type: core.Output }],
            cellDblClick: [{ type: core.Output }]
        };
    ...
    var DatagridCellEditableDirective = /** @class */ (function () {
        function DatagridCellEditableDirective(injector, el, render, dg, ngZone) {
            ...
            if (!this.cellEditorCreatedSubscription) {
                this.cellEditorCreatedSubscription = this.dgs.cellEditorCreated.pipe(operators.takeUntil(this.destroy$)).pipe(operators.filter((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
            ...
            this.dg.dgs.cellEditorDestory.pipe(operators.takeUntil(this.destroy$)).pipe(operators.filter((/**
             * @param {?} __0
             * @return {?}
             */
            function (_a) {
        ...
        function () {
            ...
            if (this.el) {
                this.el.nativeElement.cancelSelected = rxjs.noop;
                this.el.nativeElement.selectCell = rxjs.noop;
                this.el.nativeElement.closeEdit = rxjs.noop;
                this.el.nativeElement.gridCellData = rxjs.noop;
                this.el.nativeElement.edit = rxjs.noop;
                this.el.nativeElement.selectCell = rxjs.noop;
                this.el = null;
            }
        };
            ...
            if (!this.dg.isSingleClick && this.dg.editMode) {
                ...
                function () {
                    if (_this.dg.isSingleClick && _this.dg.editable && _this.dg.editMode === 'cell') {
                        ...
                        //     return;
                        // }
                        _this.closeEditingCell().pipe(operators.takeUntil(_this.destroy$)).subscribe((/**
                         * @param {?} f
                         * @return {?}
                         */
                        function (f) {
        ...
        function (event) {
            ...
            if (this.dg.editable && this.dg.editMode === 'cell') {
                ...
                //     return;
                // }
                this.closeEditingCell().pipe(operators.takeUntil(this.destroy$)).subscribe((/**
                 * @param {?} f
                 * @return {?}
                 */
                function (f) {
        ...
        function () {
            ...
            beforeEditEvent.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} flag
             * @return {?}
             */
            function (flag) {
        ...
        function () {
            ...
            /** @type {?} */
            var cellEndEdit = rxjs.of(undefined);
            afterEditEvent.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} flag
             * @return {?}
             */
            function (flag) {
        ...
        function (e) {
            ...
            switch (keyCode) {
                case 32: // SPACE
                    ...
                    break;
                case 13: // Enter
                    this.closeEditingCell().pipe(operators.takeUntil(this.destroy$)).pipe(operators.debounceTime(100)).subscribe((/**
                     * @param {?} f
                     * @return {?}
                     */
                    function (f) {
        ...
        DatagridCellEditableDirective.propDecorators = {
            rowData: [{ type: core.Input, args: ['cell-editable',] }],
            column: [{ type: core.Input }],
            dc: [{ type: core.ContentChild, args: [DatagridCellComponent,] }]
        };
    ...
    var DatagridRowsComponent = /** @class */ (function () {
        ...
        function () {
            var _this = this;
            /** @type {?} */
            var _s3 = this.dg.dgs.setSelecedRow.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} r
             * @return {?}
             */
            function (r) {
            ...
            /** @type {?} */
            var _s4 = this.dg.dfs.rowAppend$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.detectChanges();
            ...
            /** @type {?} */
            var _s5 = this.dg.dfs.rowUpdate$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} row
             * @return {?}
             */
            function (row) {
            ...
            this.dg.dfs.checkRow$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
            ...
            this.dg.dfs.clearCheckeds$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.checkedRows = _this.dg.dfs.getCheckeds();
        ...
        DatagridRowsComponent.propDecorators = {
            ...
            data: [{ type: core.Input }],
            columns: [{ type: core.Input }],
            tableEl: [{ type: core.ViewChild, args: ['tableEl',] }],
            fixedRight: [{ type: core.Input }],
            hasFixedColumns: [{ type: core.Input }]
        };
    ...
    var DatagridHeaderComponent = /** @class */ (function () {
        function DatagridHeaderComponent(render2, injector, dg, ngZone) {
            ...
            this.dgs.scorll$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} d
             * @return {?}
             */
            function (d) {
            ...
            this.dgs.showFixedShadow.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} e
             * @return {?}
             */
            function (e) {
            ...
            this.dgs.disableHeader.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} flag
             * @return {?}
             */
            function (flag) {
        ...
        function () {
            var _this = this;
            this.dgs.checkedRowsTotalChanged$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                if (_this._chkall) {
            ...
            this.dgs.uncheckAll.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
            ...
            this.dgs.checkAll.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                if (_this._chkall) {
            ...
            this.dgs.scrollbarUpdate.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} ps
             * @return {?}
             */
            function (ps) {
            ...
            this.dgs.showGridHeader.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.setHeaderPosition();
            }));
            this.dgs.smartFilterBarExpand.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.setHeaderPosition();
        ...
        DatagridHeaderComponent.propDecorators = {
            ...
            columnsGroup: [{ type: core.Input }],
            enableDragColumn: [{ type: core.Input }],
            wrapHeader: [{ type: core.Input }],
            enableFilterRow: [{ type: core.Input }],
            scrollbarMode: [{ type: core.Input }],
            fast: [{ type: core.Input }],
            header: [{ type: core.ViewChild, args: ['header',] }],
            headerColumnsTable: [{ type: core.ViewChild, args: ['headerContainer',] }],
            fixedLeft: [{ type: core.ViewChild, args: ['fixedLeft',] }],
            chkAll: [{ type: core.ViewChild, args: ['chkAll',] }],
            fr: [{ type: core.ViewChild, args: ['fixedRight',] }]
        };
    ...
    var DatagridResizeColumnDirective = /** @class */ (function () {
        ...
        function () {
            ...
            if (this.isEnable()) {
                ...
                function () {
                    ...
                    /** @type {?} */
                    var mouseUp$ = rxjs.fromEvent(_this.resizer, 'mouseup');
                    _this.resizerMouseDownListener = rxjs.fromEvent(_this.resizer, 'mousedown').pipe(
                    // debounceTime(260),
                    operators.takeUntil(mouseUp$)).subscribe((/**
                     * @param {?} e
                     * @return {?}
                     */
                    function (e) {
        ...
        DatagridResizeColumnDirective.ctorParameters = function () { return [
            { type: DatagridHeaderComponent, decorators: [{ type: core.Optional }] },
            { type: core.NgZone },
            { type: core.ElementRef },
            { type: core.Renderer2 }
        ]; };
        DatagridResizeColumnDirective.propDecorators = {
            col: [{ type: core.Input, args: ['resize-column',] }],
            onDblClickHandler: [{ type: core.HostListener, args: ['dblclick',] }]
        };
    ...
    var DatagridFooterComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.scrollXSubscription = this.dgs.scorll$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} d
             * @return {?}
             */
            function (d) {
        ...
        DatagridFooterComponent.propDecorators = {
            ...
            hasFixedColumns: [{ type: core.Input }],
            fast: [{ type: core.Input }],
            footerContainer: [{ type: core.ViewChild, args: ['footerContainer',] }],
            footerBody: [{ type: core.ViewChild, args: ['footerBody',] }],
            footerBody2: [{ type: core.ViewChild, args: ['footerBody2',] }],
            fixedLeft: [{ type: core.ViewChild, args: ['fixedLeft',] }],
            fr: [{ type: core.ViewChild, args: ['fixedRight',] }]
        };
    ...
    var DatagridPagerComponent = /** @class */ (function () {
        function DatagridPagerComponent(el, cd, inject) {
            ...
            this.removeSelectedItem = new core.EventEmitter();
            this.clearSelectedItem = new core.EventEmitter();
        ...
        DatagridPagerComponent.propDecorators = {
            ...
            selectedData: [{ type: core.Input }],
            viewMode: [{ type: core.Input }],
            listItemFormatter: [{ type: core.Input }],
            showSelectedList: [{ type: core.Input }],
            showGotoInput: [{ type: core.Input }],
            ...
            removeSelectedItem: [{ type: core.Output }],
            clearSelectedItem: [{ type: core.Output }],
            pc: [{ type: core.ViewChild, args: ['pagerContainer',] }],
    ...
    var SelectedItemPipe = /** @class */ (function () {
        ...
        SelectedItemPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'selectedItem' },] }
        ];
    ...
    var DatagridCheckboxComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.subscriptions.push(this.dg.checkAll.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                /** @type {?} */
            ...
            this.subscriptions.push(this.dg.unCheckAll.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} e
             * @return {?}
             */
            function (e) {
            ...
            /** @type {?} */
            var _setcheckrows = this.dg.dgs.setCheckedRows.pipe(operators.takeUntil(this.destroy$)).pipe(operators.filter((/**
             * @param {?} r
             * @return {?}
             */
            function (r) {
            ...
            this.dfs.updateCheckboxState$.pipe(operators.takeUntil(this.destroy$)).pipe(operators.filter((/**
             * @param {?} r
             * @return {?}
             */
            function (r) {
    ...
    var DatagridHeaderCheckboxComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.dg.dgs.changeCheckAllStatus.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @param {?} status
             * @return {?}
             */
            function (status) {
    ...
    var RowDataIdPipe = /** @class */ (function () {
        ...
        RowDataIdPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'rowDataId' },] }
        ];
        /** @nocollapse */
    ...
    var FormatGroupRowPipe = /** @class */ (function () {
        ...
        FormatGroupRowPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'formatGroupRow' },] }
        ];
        /** @nocollapse */
        FormatGroupRowPipe.ctorParameters = function () { return [
            { type: DatagridFacadeService, decorators: [{ type: core.Optional }] }
        ]; };
    ...
    var FixedLeftRowsComponent = /** @class */ (function () {
        function FixedLeftRowsComponent(cd, dg, dgb, dfs, el, injector, ngZone) {
            ...
            this.destroy$ = new rxjs.Subject();
            this.dgs = this.injector.get(DatagridService);
            this.render2 = this.injector.get(core.Renderer2);
        }
        /**
         * @private
         * @return {?}
        ...
        function () {
            ...
            /** @type {?} */
            var _setselectrow = this.dgs.setSelecedRow.pipe(operators.takeUntil(this.destroy$))
                .subscribe((/**
             * @param {?} r
             * @return {?}
             */
            ...
            this.dfs.checkRow$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
            ...
            this.dfs.clearCheckeds$.pipe(operators.takeUntil(this.destroy$)).subscribe((/**
             * @return {?}
             */
            function () {
                _this.checkedRows = _this.dfs.getCheckeds();
    ...
    var ReplaceXPipe = /** @class */ (function () {
        ...
        ReplaceXPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'replaceX' },] }
        ];
        return ReplaceXPipe;
    }());
    ...
    var DatagridGroupRowDirective = /** @class */ (function () {
        ...
        function () {
            if (this.dg.groupStyler) {
                /** @type {?} */
                var styler = this.dg.groupStyler(this.groupRow);
                /** @type {?} */
        ...
        DatagridGroupRowDirective.propDecorators = {
            groupRow: [{ type: core.Input, args: ['group-row',] }]
        };
    ...
    var ShowRequiredStarPipe = /** @class */ (function () {
        ...
        ShowRequiredStarPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'showStar' },] }
        ];
    ...
    var DisableRowPipe = /** @class */ (function () {
        ...
        DisableRowPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'disableRow' },] }
        ];
    ...
    var SelectedRowPipe = /** @class */ (function () {
        ...
        SelectedRowPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'selectedRow' },] }
        ];
        /** @nocollapse */
    ...
    var FieldValuePipe = /** @class */ (function () {
        ...
        FieldValuePipe.decorators = [
            { type: core.Pipe, args: [{ name: 'fieldvalue' },] }
        ];
    ...
    var DatagridCellTooltipDirective = /** @class */ (function () {
        ...
        DatagridCellTooltipDirective.propDecorators = {
            enable: [{ type: core.Input, args: ['cell-tooltip',] }],
            position: [{ type: core.Input }],
    ...
    var CellTootipMessagePipe = /** @class */ (function () {
        ...
        function (col) {
            ...
            if (col.showTips) {
                this.colFormatSer = this.injector.get(column.ColumnFormatService);
                /** @type {?} */
        ...
        CellTootipMessagePipe.decorators = [
            { type: core.Pipe, args: [{ name: 'tipmsg', pure: false },] }
        ];
        /** @nocollapse */
    ...
    var DatagridFilterToolbarComponent = /** @class */ (function () {
        ...
        function () {
            ...
            this.dg = this.inject.get(DatagridComponent);
            this.dfrs = this.dg.clientFilterService;
            this.dgs.clearFilter.pipe(operators.takeUntil(this.destory$)).subscribe((/**
             * @return {?}
             */
            function () {
            ...
            this.filterChangeSubscription = this.dgs.onFilterChanged.pipe(operators.takeUntil(this.destory$)).subscribe((/**
             * @param {?} n
             * @return {?}
             */
            function (n) {
        ...
        DatagridFilterToolbarComponent.propDecorators = {
            enableFilterSetting: [{ type: core.Input }],
            filterPanelRef: [{ type: core.ViewChild, args: ['filterPanel',] }],
            filterPanelTextRef: [{ type: core.ViewChild, args: ['filterPanelText',] }],
            filterTextRef: [{ type: core.ViewChild, args: ['filterbarTxt',] }],
            filterToolbarRef: [{ type: core.ViewChild, args: ['filterToolbar',] }]
        };
    ...
    var HeaderStyleDirective = /** @class */ (function () {
        ...
        HeaderStyleDirective.propDecorators = {
            column: [{ type: core.Input, args: ['header-style',] }]
        };
    ...
    var RowIsSelectedPipe = /** @class */ (function () {
        ...
        RowIsSelectedPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'rowIsSelected', pure: false },] }
        ];
        /** @nocollapse */
    ...
    var RowIsCheckedPipe = /** @class */ (function () {
        ...
        RowIsCheckedPipe.decorators = [
            { type: core.Pipe, args: [{ name: 'rowIsChecked', pure: false },] }
        ];
        /** @nocollapse */
    ...
    var AutoHeightDirective = /** @class */ (function () {
        ...
        AutoHeightDirective.propDecorators = {
            autoHeight: [{ type: core.Input, args: ['auto-height',] }],
            wheelHeight: [{ type: core.Input }]
        };
    ...
    var DatagridRowDblClickDirective = /** @class */ (function () {
        ...
        DatagridRowDblClickDirective.propDecorators = {
            dblclickRowEvent: [{ type: core.HostListener, args: ['dblclick', ['$event'],] }]
        };
    ...
    var DragDropColumnService = /** @class */ (function () {
        ...
        /** @nocollapse */ DragDropColumnService.ngInjectableDef = core.defineInjectable({ factory: function DragDropColumnService_Factory() { return new DragDropColumnService(); }, token: DragDropColumnService, providedIn: "root" });
    ...
    var DragColumnDirective = /** @class */ (function () {
        ...
        DragColumnDirective.propDecorators = {
            enableDrag: [{ type: core.Input, args: ['drag-column',] }],
    ...
    var GroupFooterRowStylerDirective = /** @class */ (function () {
        ...
        GroupFooterRowStylerDirective.propDecorators = {
            column: [{ type: core.Input }],
            rowData: [{ type: core.Input, args: ['group-footer-row-styler',] }],
            rowIndex: [{ type: core.Input }]
        };
    ...
    var DatagridModule = /** @class */ (function () {
        ...
        DatagridModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        providers: [
                            { provide: core.ErrorHandler, useClass: DatagridErrorHandler },
                            {
    ...
    exports.ALLOW_EDIT_CELL_HIGHLIGHT_CLS = ALLOW_EDIT_CELL_HIGHLIGHT_CLS;
    exports.AutoHeightDirective = AutoHeightDirective;
    exports.CELL_EDITING_CLS = CELL_EDITING_CLS;
    exports.CELL_SELECTED_CLS = CELL_SELECTED_CLS;
    exports.CalculationType = CalculationType;
    exports.ColumnFilterType = ColumnFilterType;
    exports.DATAGRID_REST_SERVICEE = DATAGRID_REST_SERVICEE;
    exports.DATAGRID_SETTING_FIELDNAME = DATAGRID_SETTING_FIELDNAME;
    exports.DataGridLoadingComponent = DataGridLoadingComponent;
    exports.DatagridBodyComponent = DatagridBodyComponent;
    exports.DatagridCellComponent = DatagridCellComponent;
    exports.DatagridCellEditableDirective = DatagridCellEditableDirective;
    exports.DatagridCellEditorDirective = DatagridCellEditorDirective;
    exports.DatagridColumnDirective = DatagridColumnDirective;
    exports.DatagridComponent = DatagridComponent;
    exports.DatagridFacadeService = DatagridFacadeService;
    exports.DatagridFilterService = DatagridFilterService;
    exports.DatagridFilterToolbarComponent = DatagridFilterToolbarComponent;
    exports.DatagridFooterComponent = DatagridFooterComponent;
    exports.DatagridHeaderComponent = DatagridHeaderComponent;
    exports.DatagridModule = DatagridModule;
    exports.DatagridPagerComponent = DatagridPagerComponent;
    exports.DatagridResizeColumnDirective = DatagridResizeColumnDirective;
    exports.DatagridRowDblClickDirective = DatagridRowDblClickDirective;
    exports.DatagridRowDirective = DatagridRowDirective;
    exports.DatagridRowHoverDirective = DatagridRowHoverDirective;
    exports.DatagridRowsComponent = DatagridRowsComponent;
    exports.DatagridService = DatagridService;
    exports.DatagridSmartFilterComponent = DatagridSmartFilterComponent;
    exports.DatagridSmartFilterModule = DatagridSmartFilterModule;
    exports.DatagridSmartFilterService = DatagridSmartFilterService;
    exports.DatagridUtils = Utils;
    exports.DomHandler = DomHandler;
    exports.DragColumnDirective = DragColumnDirective;
    exports.DragDropColumnService = DragDropColumnService;
    exports.DropColumnDirective = DropColumnDirective;
    exports.FIXED_LEFT_SHADOW_CLS = FIXED_LEFT_SHADOW_CLS;
    exports.FIXED_RIGHT_SHADOW_CLS = FIXED_RIGHT_SHADOW_CLS;
    exports.FilterRowCreateDirective = FilterRowCreateDirective;
    exports.FooterCellStylerDirective = FooterCellStylerDirective;
    exports.GRID_EDITORS = GRID_EDITORS;
    exports.GRID_FILTER_ROW = GRID_FILTER_ROW;
    exports.GRID_SETTINGS_HTTP = GRID_SETTINGS_HTTP;
    exports.GRID_SETTINGS_PANEL = GRID_SETTINGS_PANEL;
    exports.GRID_SETTINGS_SERVICE = GRID_SETTINGS_SERVICE;
    exports.GRID_VALIDATORS = GRID_VALIDATORS;
    exports.GridCellEditorDirective = GridCellEditorDirective;
    exports.GroupFooterRowStylerDirective = GroupFooterRowStylerDirective;
    exports.HeaderStyleDirective = HeaderStyleDirective;
    exports.NgxPaginationModule = NgxPaginationModule;
    exports.PagerSelectedListComponent = PagerSelectedListComponent;
    exports.PaginationService = PaginationService;
    exports.ROW_HOVER_CLS = ROW_HOVER_CLS;
    exports.ROW_SELECTED_CLS = ROW_SELECTED_CLS;
    exports.RestService = RestService;
    exports.SCROLLBAR_CONFIG = SCROLLBAR_CONFIG;
    exports.SCROLL_DOWN_ACTION = SCROLL_DOWN_ACTION;
    exports.SCROLL_LEFT_ACTION = SCROLL_LEFT_ACTION;
    exports.SCROLL_RIGHT_ACTION = SCROLL_RIGHT_ACTION;
    exports.SCROLL_UP_ACTION = SCROLL_UP_ACTION;
    exports.SCROLL_X_ACTION = SCROLL_X_ACTION;
    exports.SCROLL_X_REACH_END_ACTION = SCROLL_X_REACH_END_ACTION;
    exports.SCROLL_X_REACH_START_ACTION = SCROLL_X_REACH_START_ACTION;
    exports.SCROLL_Y_ACTION = SCROLL_Y_ACTION;
    exports.SCROLL_Y_REACH_END_ACTION = SCROLL_Y_REACH_END_ACTION;
    exports.SCROLL_Y_REACH_START_ACTION = SCROLL_Y_REACH_START_ACTION;
    exports.SIZE_TYPE = SIZE_TYPE;
    exports.ScrollbarArrowsComponent = ScrollbarArrowsComponent;
    ...
    exports.SelectedItemPipe = SelectedItemPipe;
    exports.SmartFilterToolbarComponent = SmartFilterToolbarComponent;
    exports.TR_ID_PREFIX = TR_ID_PREFIX;
    exports.TR_PREFIX = TR_PREFIX;
    exports.TextboxEditorComponent = TextboxEditorComponent;
    exports.ValidatorMessagerService = ValidatorMessagerService;
    exports.defaultPaginationInfo = defaultPaginationInfo;
    exports.ɵa = SafePipe;
    exports.ɵb = FormatCellDataPipe;
    exports.ɵc = RowDataIdPipe;
    exports.ɵd = FormatGroupRowPipe;
    exports.ɵe = ShowRequiredStarPipe;
    exports.ɵf = FieldValuePipe;
    exports.ɵg = ReplaceXPipe;
    exports.ɵh = DisableRowPipe;
    exports.ɵi = SelectedRowPipe;
    exports.ɵj = CellIsReadonlyPipe;
    exports.ɵk = CellTootipMessagePipe;
    exports.ɵl = FixedLeftRowsComponent;
    exports.ɵm = DatagridCheckboxComponent;
    exports.ɵn = DatagridHeaderCheckboxComponent;
    exports.ɵo = DatagridGroupRowDirective;
    exports.ɵp = DatagridCellTooltipDirective;
    exports.ɵq = AutoHeightComponent;
    exports.ɵr = RowIsSelectedPipe;
    exports.ɵs = ɵs;
    exports.ɵt = DatagridErrorHandler;
    exports.ɵu = RowIsCheckedPipe;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=farris-ui-datagrid.umd.js.map
