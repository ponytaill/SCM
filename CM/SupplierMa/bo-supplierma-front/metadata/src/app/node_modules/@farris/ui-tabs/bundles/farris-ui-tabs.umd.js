(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('resize-observer-polyfill'), require('@farris/ui-common'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-tabs', ['exports', 'rxjs', 'rxjs/operators', 'resize-observer-polyfill', '@farris/ui-common', '@angular/core', '@angular/common', '@angular/forms', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-tabs'] = {}),global.rxjs,global.rxjs.operators,global.ResizeObserver,global.uiCommon,global.ng.core,global.ng.common,global.ng.forms,global.uiLocale));
}(this, (function (exports,rxjs,operators,ResizeObserver,uiCommon,core,common,forms,uiLocale) { 'use strict';
