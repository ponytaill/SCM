(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-input-group'), require('@angular/common'), require('resize-observer-polyfill'), require('lodash-es'), require('@farris/ui-perfect-scrollbar'), require('@angular/forms'), require('@farris/ui-common/column'), require('@farris/ui-common/events'), require('@angular/platform-browser'), require('@farris/ui-locale'), require('@farris/ui-pagination'), require('rxjs/operators'), require('rxjs'), require('@farris/ui-common'), require('@farris/ui-context-menu'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-treetable', ['exports', '@farris/ui-input-group', '@angular/common', 'resize-observer-polyfill', 'lodash-es', '@farris/ui-perfect-scrollbar', '@angular/forms', '@farris/ui-common/column', '@farris/ui-common/events', '@angular/platform-browser', '@farris/ui-locale', '@farris/ui-pagination', 'rxjs/operators', 'rxjs', '@farris/ui-common', '@farris/ui-context-menu', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-treetable'] = {}),global.uiInputGroup,global.ng.common,global.ResizeObserver,global.lodashEs,global.uiPerfectScrollbar,global.ng.forms,global.column,global.events,global.ng.platformBrowser,global.uiLocale,global.uiPagination,global.rxjs.operators,global.rxjs,global.uiCommon,global.uiContextMenu,global.ng.core));
}(this, (function (exports,uiInputGroup,common,ResizeObserver,lodashEs,uiPerfectScrollbar,forms,column,events,i1,uiLocale,uiPagination,operators,rxjs,uiCommon,uiContextMenu,i0) { 'use strict';
            ...
            function ($event) {
                ...
                if (searchValue && searchValue.length >= 2) {
                    ...
                    if (result && result.length) {
                        ...
                        this.findCurrent = 1;
                        __spread(parents, result).forEach(( /**
                         * @param {?} r
                         * @return {?}
                         */function (r) {
