(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash-es'), require('rxjs'), require('rxjs/operators'), require('@farris/ui-locale'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-pagination'), require('@farris/ui-common'), require('@farris/ui-common/column'), require('@farris/ui-input-group')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-datatable', ['exports', 'lodash-es', 'rxjs', 'rxjs/operators', '@farris/ui-locale', '@angular/core', '@angular/common', '@angular/forms', '@farris/ui-perfect-scrollbar', '@farris/ui-pagination', '@farris/ui-common', '@farris/ui-common/column', '@farris/ui-input-group'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-datatable'] = {}),global.lodashEs,global.rxjs,global.rxjs.operators,global.uiLocale,global.ng.core,global.ng.common,global.ng.forms,global.uiPerfectScrollbar,global.uiPagination,global.uiCommon,global.column,global.uiInputGroup));
}(this, (function (exports,lodashEs,rxjs,operators,uiLocale,core,common,forms,uiPerfectScrollbar,uiPagination,uiCommon,column,uiInputGroup) { 'use strict';
    ...
    var DataTableComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                if (this.pgScrollbar) {
                    rxjs.fromEvent(this.pgScrollbar.nativeElement, 'scroll').pipe(operators.delay(50)).subscribe(( /**
                     * @param {?} e
                     * @return {?}
                     */function (e) {
                        // console.log(e)
