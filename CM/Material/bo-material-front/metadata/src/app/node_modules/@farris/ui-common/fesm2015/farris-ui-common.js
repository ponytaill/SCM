...
import { Directive, Input, TemplateRef, Output, ElementRef, EventEmitter, Injectable, Pipe, NgModule, defineInjectable, inject } from '@angular/core';
        ...
        if (!this.debugSub) {
            ...
            (e) => {
                if (e.ctrlKey && e.shiftKey && e.key === 'D') {
                    ...
                    console.log(`🪲%cFarris debug mode is ${this.isDebug ? 'startting' : 'stopped'}.🪲`, 'color: blue; font-weight:bold;font-size:16px');
                }
            }));
        }
