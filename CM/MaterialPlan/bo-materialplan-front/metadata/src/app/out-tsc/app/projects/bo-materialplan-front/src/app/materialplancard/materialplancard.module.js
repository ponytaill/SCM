...
import { MaterialPlanCardRoutingModule } from './routing';
...
import { PlandetailsComponent } from './components/plandetails-component/plandetailscomponent';
...
var MaterialPlanCardModule = /** @class */ (function () {
    ...
    MaterialPlanCardModule = tslib_1.__decorate([
        NgModule({
            exports: [
                RootComponent
            ],
