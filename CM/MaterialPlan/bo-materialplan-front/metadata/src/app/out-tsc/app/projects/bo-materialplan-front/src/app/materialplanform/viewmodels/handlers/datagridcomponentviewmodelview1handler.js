...
var datagridcomponentviewmodelView1Handler = /** @class */ (function (_super) {
    tslib_1.__extends(datagridcomponentviewmodelView1Handler, _super);
    ...
    datagridcomponentviewmodelView1Handler = tslib_1.__decorate([
        Injectable(),
        NgCommandHandler({
...
export { datagridcomponentviewmodelView1Handler };
