...
import { dataImport1Handler } from '../../viewmodels/handlers/dataimport1handler';
import { dataExport1Handler } from '../../viewmodels/handlers/dataexport1handler';
import { listDataExport1Handler } from '../../viewmodels/handlers/listdataexport1handler';
import { rootviewmodelgetMinDate1Handler } from '../../viewmodels/handlers/rootviewmodelgetmindate1handler';
...
@Component({
    ...
    providers: [
        ...
        MaterialDetailFrmMinDateService1,
        DIP_DATAIE_SERVICE,
...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        const states = {
                'plandetailsAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'plandetailsRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
