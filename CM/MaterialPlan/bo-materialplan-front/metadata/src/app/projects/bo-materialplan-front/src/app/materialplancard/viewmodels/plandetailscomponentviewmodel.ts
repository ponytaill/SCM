...
@Injectable()
export class PlandetailsComponentViewmodel extends ViewModel {
    public bindingPath = '/planDetailss';
    // farrisDataGrid列集合定义 在对应component中赋值
    public dataGrid_plandetailsColumns:any;
  ...
  "dataGrid_plandetails": {
    ...
    public plandetailsAddItem1(commandParam?: any): Observable<any> { return; }
    ...
    public plandetailsRemoveItem1(commandParam?: any): Observable<any> { return; }
    ...
    public rootviewmodelInsert1(commandParam?: any): Observable<any> { return; }
    ...
    public rootviewmodelAddItem1(commandParam?: any): Observable<any> { return; }
