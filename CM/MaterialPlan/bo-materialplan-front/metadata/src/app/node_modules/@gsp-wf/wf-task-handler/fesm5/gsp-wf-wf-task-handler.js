    ...
    function (tasks) {
        ...
        if ((this.actionEntity.code === 'Back' || this.actionEntity.code === 'Refuse') && !this.comment) { // 批量意见是否必填不支持根据审批项配置操作，批量驳回意见必填
            ...
            if (actTasks_1 && actTasks_1.length > 0) {
                this.executeBatchEvent(__spread(this.actionEntity.preEvents.filter(function (e) { return e.batch; })), actTasks_1, this.actionEntity, function (re) {
                    var e_2, _a;
                    if (re && re.result) {
                        if (re.passTasks) {
                            /** @type {?} */
                        ...
                        if (actTasks_1.length > 0) {
                            ...
                            _this.batchverifySubmit(actTasks_1, filterNum, batchVerifySignedcontext).subscribe(function (r) {
                                if (r && r.successSubmit && r.successSubmit.result) {
                                    _this.executeBatchEvent(__spread(_this.actionEntity.postEvents.filter(function (e) { return e.batch; })), r.successHandleTasks, _this.actionEntity, function () {
...
var WfTaskHandlerService = /** @class */ (function () {
    ...
    function (dataIds, bizDefKey) {
        ...
        this.batchSubmitHelpFunction(__spread(dataIds), bizDefKey, function () {
            load.close();
            subject.next(true);
        });
        return subject.asObservable();
    ...
    function (dataIds, bizDefKey) {
        ...
        this.batchCancelHelpFunction(__spread(dataIds), bizDefKey, function () {
            load.close();
            subject.next(true);
        });
        return subject.asObservable();
...
var TaskCommentComponent = /** @class */ (function () {
    ...
    function () {
        ...
        this.taskService.getCommentList().subscribe(function (data) {
            ...
            _this.originCommentList = __spread(data);
        });
    };
    /**
