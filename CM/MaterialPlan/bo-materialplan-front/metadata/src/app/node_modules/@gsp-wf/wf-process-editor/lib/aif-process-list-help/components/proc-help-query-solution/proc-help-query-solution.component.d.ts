...
export declare class ProcHelpQuerySolutionComponent implements OnInit {
    ...
    comboProcessTypeIdField: string;
    comboProcessTypeValueField: string;
    comboProcessTypeTextField: string;
    comboProcessTypeData: {
        value: string;
        text: any;
    }[];
    comboEnabledState: ComboListComponent;
    comboEnabledStateIdField: string;
    comboEnabledStateValueField: string;
    comboEnabledStateTextField: string;
