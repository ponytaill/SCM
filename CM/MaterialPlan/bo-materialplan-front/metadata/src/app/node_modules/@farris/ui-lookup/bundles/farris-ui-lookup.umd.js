(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-shortcuts'), require('@farris/ui-common/types'), require('rxjs'), require('@angular/platform-browser'), require('lodash-es'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-layout'), require('@farris/ui-messager'), require('@farris/ui-datatable'), require('@farris/ui-treetable'), require('@farris/ui-loading'), require('@angular/animations'), require('@farris/ui-locale'), require('@farris/ui-notify'), require('@farris/ui-context-menu'), require('@farris/ui-common'), require('@farris/ui-input-group'), require('rxjs/operators'), require('@angular/core'), require('@farris/ui-dialog')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-lookup', ['exports', '@farris/ui-shortcuts', '@farris/ui-common/types', 'rxjs', '@angular/platform-browser', 'lodash-es', '@angular/common', '@angular/forms', '@farris/ui-layout', '@farris/ui-messager', '@farris/ui-datatable', '@farris/ui-treetable', '@farris/ui-loading', '@angular/animations', '@farris/ui-locale', '@farris/ui-notify', '@farris/ui-context-menu', '@farris/ui-common', '@farris/ui-input-group', 'rxjs/operators', '@angular/core', '@farris/ui-dialog'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-lookup'] = {}),global.uiShortcuts,global.types,global.rxjs,global.ng.platformBrowser,global.lodashEs,global.ng.common,global.ng.forms,global.uiLayout,global.uiMessager,global.uiDatatable,global.uiTreetable,global.uiLoading,global.ng.animations,global.uiLocale,global.uiNotify,global.uiContextMenu,global.uiCommon,global.uiInputGroup,global.rxjs.operators,global.ng.core,global.uiDialog));
}(this, (function (exports,uiShortcuts,types,rxjs,platformBrowser,lodashEs,common,forms,uiLayout,uiMessager,uiDatatable,uiTreetable,uiLoading,animations,uiLocale,uiNotify,uiContextMenu,uiCommon,uiInputGroup,operators,core,uiDialog) { 'use strict';
    ...
    ***************************************************************************** */
                            ...
                            if (nodes && nodes.length) {
                                 ...
                                 */function (node) {
                                    ...
                                    if (node.children && node.children.length) {
                                        ...
                                        if (_this_1._isLoadAllTreeData(tt)) {
                                            node.leaf = true;
                                        }
                                    }
                                    return node;
                        ...
                        if (!_this_1.ins.singleSelect) {
                            ...
                            if (tt.loadDataType !== 'all' && _this_1.ins.treeInfo.layerType === 'pathcode' &&
                                ...
                                if (e.node.children && e.node.children.length) {
                                    ...
                                    /** @type {?} */
                                    var pathcode = _this_1.ins.getPathCode(e.node.data, _this_1.ins.treeInfo);
         ...
         */
            function (event, type) {
                ...
                if (this.ins.condition) {
                    params.condition = lodashEs.cloneDeep(this.ins.condition);
                }
                /** @type {?} */
         ...
         */
            function () {
                ...
                if (this.ins.http && this.ins.http['getUserSettings']) {
                    return this.ins.http['getUserSettings'](key).pipe(operators.map(( /**
                     * @param {?} ucs
                     * @return {?}
                     */function (ucs) {
                        if (ucs) {
    ...
    var LookupLeftComponent = /** @class */ (function () {
         ...
         */
            function (params) {
                return __assign({}, params, { treeToList: this.lookupCmp.treeToList, navTreeToList: this.lookupCmp.navTreeToList });
            };
        /**
         * @private
         * @param {?} tt
         ...
         */
            function (parentPath, parentLayer, searchData, tt) {
                ...
                /** @type {?} */
                var search = __assign({ parentLayer: parentLayer, category: 'nav' }, searchData);
    ...
    var LookupGridComponent = /** @class */ (function (_super) {
        ...
        LookupGridComponent.propDecorators = {
            ...
            multiSelectDT: [{ type: core.ViewChild, args: ["multiSelectDT",] }],
    ...
    var LookupTabsComponent = /** @class */ (function () {
        ...
        LookupTabsComponent.propDecorators = {
            ...
            enableSelected: [{ type: core.Input }],
            selectedTotal: [{ type: core.Input }],
    ...
    var LookupAdvancedLayoutComponent = /** @class */ (function () {
        ...
        LookupAdvancedLayoutComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        template: "<div class=\"d-flex justify-content-between header\" #header [style.cursor]=\"dialogRef.isMax ? 'default': 'move'\">\r\n    <div class=\"title\">{{title}}</div>\r\n\r\n    <div style=\"width: 100%;\" class=\"tabs\">\r\n        <div class=\"d-flex justify-content-center\">\r\n            <div class=\"d-flex tabs-labels\" *ngIf=\"enableFav\"  (mousedown)=\"$event.stopPropagation()\">\r\n                <div class=\"active-tab\" #activetab></div>\r\n                <div class=\"tab-title d-flex\" [class.active]=\"activeTab === 'datalist'\" (click)=\"changeTabs($event, 'datalist')\" >\r\n                    {{ 'lookup.datalist' | locale: '\u6570\u636E\u5217\u8868' }}\r\n                </div>\r\n                <div class=\"tab-title d-flex\" [class.active]=\"activeTab === 'favorite'\" (click)=\"changeTabs($event, 'favorite')\">\r\n                    {{'lookup.favorites' | locale: '\u6536\u85CF\u5939'}}\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n\r\n    <div class=\"close d-flex flex-row h-100\">\r\n        <span class=\"f-icon modal_maximize\" [class.modalrevert]=\"dialogRef.isMax\" (click)=\"changeDialogSize($event)\"></span>\r\n        <span class=\"f-icon modal_close\" (click)=\"closeDialog($event)\"></span>\r\n    </div>\r\n</div>",
                        encapsulation: core.ViewEncapsulation.None,
                        styles: [".lookup-advanced-layout .header{position:relative;width:100%;height:56px;border:0;cursor:move}.lookup-advanced-layout .title{display:block;white-space:nowrap;font-size:17px;line-height:56px;position:absolute}.lookup-advanced-layout .tabs{width:100%;height:32px;top:12px;font-size:14px;position:relative;line-height:32px}.lookup-advanced-layout .tabs .tabs-labels{background:#eff5ff;border-radius:17px;color:#6080ad;cursor:pointer;-webkit-box-align:center;align-items:center}.lookup-advanced-layout .tabs .tabs-labels .active{cursor:default;color:#2a87ff}.lookup-advanced-layout .tabs .tabs-labels .tab-title{border:0;z-index:2;-webkit-box-pack:center;justify-content:center;width:84px}.lookup-advanced-layout .close{line-height:56px;padding:0;z-index:55555;position:absolute;right:0;-webkit-box-pack:justify;justify-content:space-between;-webkit-box-align:center;align-items:center;width:44px}.lookup-advanced-layout .active-tab{position:absolute;width:80px;z-index:1;-webkit-transition:.18s ease-in;transition:.18s ease-in;line-height:28px;margin:2px;height:28px;background:rgba(255,255,255,.9);box-shadow:0 4px 18px 0 rgba(2,75,193,.2);border-radius:15px}"]
                    }] }
        ];
        /** @nocollapse */
    ...
    var LookupModule = /** @class */ (function () {
        ...
        LookupModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        providers: [],
                        entryComponents: [uiDatatable.DataTableComponent, uiTreetable.TreeTableComponent, LookupLeftComponent, LookupTabsComponent, LookupQuickSelectPanelComponent]
                    },] }
        ];
        return LookupModule;
    }());
    ...
    exports.LookupLayout = LookupLayout;
