(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@farris/devkit', ['exports', 'moment', 'immutable', '@angular/forms', 'validator', 'date-fns', '@angular/common/http', '@angular/router', '@farris/expression-engine', 'bignumber.js', 'rxjs/operators', 'rxjs', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris.devkit = {}),global.moment,global.immutable,global.ng.forms,global.ValidatorJS,global.dateFns,global.ng.common.http,global.ng.router,global.expressionEngine,global.bignumber_js,global.rxjs.operators,global.rxjs,global.ng.core));
}(this, (function (exports,moment,immutable,forms,ValidatorJS,dateFns,http,router,expressionEngine,bignumber_js,operators,rxjs,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var GROUP_FUNCTIONS = ['SumByProp', 'CountByProp', 'AvgByProp', 'MaxByProp', 'MinByProp', 'IsExistRecord', 'ListContains', 'ListGreaterThan', 'ListLessThan', 'ListStartWith', 'ListEndWith', 'MultiplyChildNumber'];
