(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('resize-observer-polyfill'), require('rxjs/operators'), require('@angular/core'), require('@angular/common'), require('@farris/ui-locale'), require('@farris/ui-common'), require('@farris/ui-tabs')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-section', ['exports', 'rxjs', 'resize-observer-polyfill', 'rxjs/operators', '@angular/core', '@angular/common', '@farris/ui-locale', '@farris/ui-common', '@farris/ui-tabs'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-section'] = {}),global.rxjs,global.ResizeObserver,global.rxjs.operators,global.ng.core,global.ng.common,global.uiLocale,global.uiCommon,global.uiTabs));
}(this, (function (exports,rxjs,ResizeObserver,operators,i0,common,uiLocale,uiCommon,uiTabs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FarrisSectionComponent = /** @class */ (function () {
        ...
        FarrisSectionComponent.propDecorators = {
            ...
            maxStatus: [{ type: i0.HostBinding, args: ["class.f-section-maximize",] }],
