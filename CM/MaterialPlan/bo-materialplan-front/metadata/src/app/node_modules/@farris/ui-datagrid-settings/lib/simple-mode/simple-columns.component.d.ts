import { ChangeDetectorRef, EventEmitter, Injector, OnInit, ElementRef } from '@angular/core';
import { LocaleService } from '@farris/ui-locale';
import { DatagridComponent } from '@farris/ui-datagrid';
import { SettingModel } from '../setting.model';
export declare class SimpleColumnsComponent implements OnInit {
    private injector;
    ...
    searchResultIsVisibleAll: boolean;
    ...
    onlySeeVisibleColumns($event: any): void;
    refresh(): void;
    hidePanel(): void;
