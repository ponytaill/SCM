...
import { debounceTime, finalize, tap, catchError, filter } from 'rxjs/operators';
import { DownloadService } from '@gsp-svc/formdoc-upload';
import { LocaleService } from '@farris/ui-locale';
import { ColumnFormatService } from '@farris/ui-common/column';
import { DateUtil, ViewModel, BindingData, ChangeType, FrameEventBus, UIState, ComponentType, FrameContext, DataTypeInfo, EntityPathConverter, RunMode, AppContext, UserSettingsToken, Repository, VariableParseService } from '@farris/devkit';
import { BigNumber } from 'bignumber.js';
import moment from 'moment';
import { DialogService } from '@farris/ui-dialog';
import { Injectable, Pipe, Directive, Input, HostListener, NgZone, Optional, EventEmitter, Output, ContentChildren, Self, Host, KeyValueDiffers, ElementRef, Renderer2, Injector, Inject, NgModule } from '@angular/core';
...
var KendoGridFilterDirective = /** @class */ (function (_super) {
    ...
    Object.defineProperty(KendoGridFilterDirective.prototype, "selectedValue", {
        get: function () {
            var filter$$1 = this.filterByField(this.column.dataField);
            return filter$$1 ? filter$$1.value : null;
        },
        enumerable: true,
        configurable: true
    });
...
var PortletFilterBindingDirective = /** @class */ (function () {
    ...
    PortletFilterBindingDirective.prototype.buildFilters = function () {
        ...
        filters.forEach(function (filter$$1) {
            result.push({
                dpId: filter$$1[_this.FilterFieldKey],
                value: _this.variableParseService.parse(filter$$1[_this.FilterValueKey], _this.frameContext)
            });
        });
        return result;
    };
    ...
    PortletFilterBindingDirective.prototype.observeChanges = function () {
        var _this = this;
        var filters = this.deserializeFilter();
        filters && filters.forEach(function (filter$$1) {
            var dependencies = _this.collectDependencies(filter$$1[_this.FilterValueKey]);
