(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ecp-caf/caf-common'), require('date-fns'), require('rxjs'), require('rxjs/operators'), require('rxjs/operators/map'), require('@angular/core'), require('@angular/common/http'), require('@farris/devkit')) :
    typeof define === 'function' && define.amd ? define('@farris/bef', ['exports', '@ecp-caf/caf-common', 'date-fns', 'rxjs', 'rxjs/operators', 'rxjs/operators/map', '@angular/core', '@angular/common/http', '@farris/devkit'], factory) :
    (factory((global.farris = global.farris || {}, global.farris.bef = {}),global.cafCommon,global.dateFns,global.rxjs,global.rxjs.operators,global.rxjs['operators/map'],global.ng.core,global.ng.common.http,global.devkit));
}(this, (function (exports,cafCommon,dateFns,rxjs,operators,map,core,http,devkit) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */ PresetBefRepository = /** @class */ (function (_super) {
        ...
        function PresetBefRepository(injector, schema) {
            ...
            _this.entityType = entityTypeFactory.create(schema);
            _this.entityTypeInfo = new devkit.DataTypeInfo(_this.entityType);
            _this.entityCollection = new devkit.EntityCollection(_this.entityType);
            // 初始化实体管理器
            _this.entityManager = new BefEntityManager(_this.entityCollection);
