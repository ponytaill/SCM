(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-common/number'), require('@progress/kendo-angular-dropdowns'), require('lodash-es'), require('@farris/extend-file-upload'), require('primeng/treetable'), require('@farris/ui-common/date'), require('@farris/ui-editor'), require('@gsp-cmp/querysolution'), require('@farris/ui-text'), require('@farris/ui-list-nav'), require('@farris/ui-list-view'), require('@farris/ui-list-filter'), require('@farris/ui-filter'), require('@farris/ui-view-change'), require('@farris/ui-html-editor'), require('@farris/ui-section'), require('@farris/ui-input-group'), require('@farris/ui-datepicker'), require('@farris/ui-time-picker'), require('@farris/ui-number-spinner'), require('@farris/ui-combo-list'), require('@farris/ui-lookup'), require('@farris/ui-datagrid'), require('@farris/ui-treetable'), require('@farris/ui-wizard'), require('@farris/discussion-group'), require('@farris/ui-nav'), require('@farris/ui-multi-select'), require('@farris/ui-scrollspy'), require('@farris/ui-combo-lookup'), require('@farris/appointment-calendar'), require('@gspwidget/portlet'), require('rxjs'), require('rxjs/operators'), require('@gsp-svc/formdoc-upload'), require('@farris/ui-locale'), require('@farris/ui-common/column'), require('@farris/devkit'), require('bignumber.js'), require('moment'), require('@farris/ui-dialog'), require('@angular/core'), require('@angular/common'), require('@progress/kendo-angular-grid'), require('@farris/ui-common')) :
    typeof define === 'function' && define.amd ? define('@farris/kendo-binding', ['exports', '@farris/ui-common/number', '@progress/kendo-angular-dropdowns', 'lodash-es', '@farris/extend-file-upload', 'primeng/treetable', '@farris/ui-common/date', '@farris/ui-editor', '@gsp-cmp/querysolution', '@farris/ui-text', '@farris/ui-list-nav', '@farris/ui-list-view', '@farris/ui-list-filter', '@farris/ui-filter', '@farris/ui-view-change', '@farris/ui-html-editor', '@farris/ui-section', '@farris/ui-input-group', '@farris/ui-datepicker', '@farris/ui-time-picker', '@farris/ui-number-spinner', '@farris/ui-combo-list', '@farris/ui-lookup', '@farris/ui-datagrid', '@farris/ui-treetable', '@farris/ui-wizard', '@farris/discussion-group', '@farris/ui-nav', '@farris/ui-multi-select', '@farris/ui-scrollspy', '@farris/ui-combo-lookup', '@farris/appointment-calendar', '@gspwidget/portlet', 'rxjs', 'rxjs/operators', '@gsp-svc/formdoc-upload', '@farris/ui-locale', '@farris/ui-common/column', '@farris/devkit', 'bignumber.js', 'moment', '@farris/ui-dialog', '@angular/core', '@angular/common', '@progress/kendo-angular-grid', '@farris/ui-common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['kendo-binding'] = {}),global.number,global.kendoAngularDropdowns,global.lodashEs,global.extendFileUpload,global.treetable,global.date,global.uiEditor,global.querysolution,global.uiText,global.uiListNav,global.uiListView,global.uiListFilter,global.uiFilter,global.uiViewChange,global.uiHtmlEditor,global.uiSection,global.uiInputGroup,global.uiDatepicker,global.uiTimePicker,global.uiNumberSpinner,global.uiComboList,global.uiLookup,global.uiDatagrid,global.uiTreetable,global.uiWizard,global.discussionGroup,global.uiNav,global.uiMultiSelect,global.uiScrollspy,global.uiComboLookup,global.appointmentCalendar,global.portlet,global.rxjs,global.rxjs.operators,global.formdocUpload,global.uiLocale,global.column,global.devkit,global.bignumber_js,global.moment,global.uiDialog,global.ng.core,global.ng.common,global.kendoAngularGrid,global.uiCommon));
}(this, (function (exports,number,kendoAngularDropdowns,lodashEs,extendFileUpload,treetable,date,uiEditor,querysolution,uiText,uiListNav,uiListView,uiListFilter,uiFilter,uiViewChange,uiHtmlEditor,uiSection,uiInputGroup,uiDatepicker,uiTimePicker,uiNumberSpinner,uiComboList,uiLookup,uiDatagrid,uiTreetable,uiWizard,discussionGroup,uiNav,uiMultiSelect,uiScrollspy,uiComboLookup,appointmentCalendar,portlet,rxjs,operators,formdocUpload,uiLocale,column,devkit,bignumber_js,moment,uiDialog,core,common,kendoAngularGrid,uiCommon) { 'use strict';
    ...
    ***************************************************************************** */
        ...
        EditableDirective.prototype.handleBeginEditEvent = function () {
            ...
            this.beginEditSubscription = this.grid.beginEdit.subscribe(function (e) {
                ...
                if (column$$1 && column$$1.editor) {
                    ...
                    if (column$$1.editor.type === 'lookup' || column$$1.editor.type === 'PersonnelSelector'
                        || column$$1.editor.type === 'OrganizationSelector' || column$$1.editor.type === 'external-integration' || 'EmployeeSelector' === column$$1.editor.type || 'EmployeeOrgSelector' === column$$1.editor.type) {
    ...
    var FarrisFilePreviewBindingDirective = /** @class */ (function () {
        ...
        FarrisFilePreviewBindingDirective.prototype.ngOnInit = function () {
            ...
            this.bindingData.changes.subscribe(function (change) {
                if (change.type === devkit.ChangeType.Load
                    || change.type === devkit.ChangeType.Append
                    || change.type === devkit.ChangeType.Remove) {
                    _this.bindData();
                }
            });
        };
    ...
    var ListNavComponentRefDirective = /** @class */ (function () {
    ...
    var FilterComponentRefDirective = /** @class */ (function () {
    ...
    var ViewChangeComponentRefDirective = /** @class */ (function () {
    ...
    var HtmlEditorComponentRefDirective = /** @class */ (function () {
    ...
    var SectionComponentRefDirective = /** @class */ (function () {
    ...
    var InputGroupComponentRefDirective = /** @class */ (function () {
    ...
    var DatepickerComponentRefDirective = /** @class */ (function () {
    ...
    var TimePickerComponentRefDirective = /** @class */ (function () {
    ...
    var NumberSpinnerComponentRefDirective = /** @class */ (function () {
    ...
    var ComboListComponentRefDirective = /** @class */ (function () {
    ...
    var LookupGridComponentRefDirective = /** @class */ (function () {
    ...
    var TreetableComponentRefDirective = /** @class */ (function () {
    ...
    var WizardComponentRefDirective = /** @class */ (function () {
    ...
    var DiscussionEditorComponentRefDirective = /** @class */ (function () {
    ...
    var NavComponentRefDirective = /** @class */ (function () {
    ...
    var MultiSelectComponentRefDirective = /** @class */ (function () {
    ...
    var ScrollspyComponentRefDirective = /** @class */ (function () {
    ...
    (function (ExpressionType) {
        ExpressionType["UIState"] = "UIState";
        ExpressionType["BindingData"] = "BindingData";
        ExpressionType["Unknow"] = "UnKnow";
    ...
    var PortletFilterBindingDirective = /** @class */ (function () {
        ...
        PortletFilterBindingDirective.prototype.ngOnInit = function () {
            var _this = this;
            // 监听数据变化，执行第一次的绑定
            this.frameContext.bindingData.changes.pipe(operators.filter(function (change) {
                return (change.type === devkit.ChangeType.Load || change.type === devkit.ChangeType.Remove || change.type === devkit.ChangeType.Update || change.type === devkit.ChangeType.SelectionChanged) && (!change.path || change.path.length < 1);
        ...
        PortletFilterBindingDirective.prototype.observeBindingDataChange = function (frameContext, paths) {
            ...
            // 只监听主表变化
            operators.filter(function (change) { return change.type === devkit.ChangeType.ValueChanged; })).subscribe(function (change) {
        ...
        /** @nocollapse */
        PortletFilterBindingDirective.ctorParameters = function () {
            return [
                { type: core.Injector },
                { type: portlet.PortletComponent },
                { type: devkit.FrameContext },
                { type: devkit.VariableParseService }
            ];
        };
        PortletFilterBindingDirective.propDecorators = {
            filters: [{ type: core.Input, args: ["portlet-filter-binding",] }]
        };
    ...
    exports.PortletFilterBindingDirective = PortletFilterBindingDirective;
