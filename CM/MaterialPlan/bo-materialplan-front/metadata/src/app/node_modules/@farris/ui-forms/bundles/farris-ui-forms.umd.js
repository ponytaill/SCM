(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('resize-observer-polyfill'), require('@farris/ui-messager'), require('@angular/platform-browser'), require('@angular/forms'), require('@farris/ui-common'), require('@farris/ui-locale'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-forms', ['exports', '@angular/common', 'resize-observer-polyfill', '@farris/ui-messager', '@angular/platform-browser', '@angular/forms', '@farris/ui-common', '@farris/ui-locale', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-forms'] = {}),global.ng.common,global.ResizeObserver,global.uiMessager,global.ng.platformBrowser,global.ng.forms,global.uiCommon,global.uiLocale,global.ng.core));
}(this, (function (exports,common,ResizeObserver,uiMessager,platformBrowser,forms,uiCommon,uiLocale,core) { 'use strict';
