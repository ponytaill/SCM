...
class ChangeSet {
    ...
    appendRemoveModification(modification) {
        ...
        this.modifications = this.modifications.filter((valueModification) => {
            ...
            valueChangePath.pop();
            // 路径相同进行移除
            const isToRemove = isEqual$1(valueChangePath, fullRemovePath);
            return !isToRemove;
        });
        // 先删除下级删除变更，再插入
...
const GROUP_FUNCTIONS = ['SumByProp', 'CountByProp', 'AvgByProp', 'MaxByProp', 'MinByProp', 'IsExistRecord', 'ListContains', 'ListGreaterThan', 'ListLessThan', 'ListStartWith', 'ListEndWith', 'MultiplyChildNumber'];
