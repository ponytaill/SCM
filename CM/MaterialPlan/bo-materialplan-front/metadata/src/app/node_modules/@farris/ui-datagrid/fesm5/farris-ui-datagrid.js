...
import { IdService, CommonUtils, FarrisComponentInstanceService, DebugService, OverLayHiddenService } from '@farris/ui-common';
            ...
            if (this.nowrap) {
                ...
                function () {
                    ...
                    if (topFooter) {
                        ...
                        _this.footerHeight = Math.max.apply(Math, __spread(Array.from(topFooter.querySelectorAll('table')).map((/**
                         * @param {?} n
                         * @return {?}
                         */
                        ...
                        if (bottomFooter) {
                            ...
                            _this.footerHeight = Math.max.apply(Math, __spread(Array.from(bottomFooter.querySelectorAll('table')).map((/**
                             * @param {?} n
                             * @return {?}
                             */
                            function (n) { return n.offsetHeight; }))));
    ...
    function () {
        ...
        function (row) {
            if (row && row.data) {
                ...
                // this.cd.detectChanges();
                _this.rowData = __assign({}, row.data);
