(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('lodash-es'), require('@angular/forms'), require('date-fns'), require('@farris/ui-time-picker'), require('@farris/ui-locale'), require('@farris/ui-popover'), require('@farris/ui-common/date'), require('@farris/ui-notify'), require('@farris/ui-common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-datepicker', ['exports', '@angular/common', 'lodash-es', '@angular/forms', 'date-fns', '@farris/ui-time-picker', '@farris/ui-locale', '@farris/ui-popover', '@farris/ui-common/date', '@farris/ui-notify', '@farris/ui-common', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-datepicker'] = {}),global.ng.common,global.lodashEs,global.ng.forms,global.dateFns,global.uiTimePicker,global.uiLocale,global.uiPopover,global.date,global.uiNotify,global.uiCommon,global.ng.core));
}(this, (function (exports,common,lodashEs,forms,dateFns,uiTimePicker,uiLocale,uiPopover,date,uiNotify,uiCommon,core) { 'use strict';
    ...
    var CalendarComponent = /** @class */ (function () {
         ...
         */
            function ($event) {
                $event.stopPropagation();
                /** @type {?} */
                var weekDays = this.dateHlp.getWeekDate({ baselineDate: new Date() });
                ...
                var day = new Date().getDate();
                /** @type {?} */
                var weekNbr = this.dateHlp.getYearWeek(year, month, day);
                /** @type {?} */
                var weekData = { week: weekDays, weekNbr: weekNbr, year: year };
         ...
         */
            function (event) {
                ...
                if (event.singleDate) {
                    ...
                    /** @type {?} */
                    var MIN_DATE = new Date(this.minDate.year + "-" + this.minDate.month + "-" + this.minDate.day + " " + this.minDate.hour + ":" + this.minDate.minute + ":" + this.minDate.second);
                    if (this.minDate.year !== 1840) {
                        ...
                        /** @type {?} */
                        var MAX_DATE = new Date(this.maxDate.year + "-" + this.maxDate.month + "-" + this.maxDate.day + " " + this.maxDate.hour + ":" + this.maxDate.minute + ":" + this.maxDate.second);
