(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('rxjs/internal/scheduler/animationFrame'), require('@angular/core'), require('@angular/common'), require('@farris/ui-locale'), require('@farris/ui-common')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-scrollspy', ['exports', 'rxjs', 'rxjs/operators', 'rxjs/internal/scheduler/animationFrame', '@angular/core', '@angular/common', '@farris/ui-locale', '@farris/ui-common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-scrollspy'] = {}),global.rxjs,global.rxjs.operators,global.rxjs['internal/scheduler/animationFrame'],global.ng.core,global.ng.common,global.uiLocale,global.uiCommon));
}(this, (function (exports,rxjs,operators,animationFrame,i0,common,uiLocale,uiCommon) { 'use strict';
            ...
            function (key) {
                 ...
                 */function () {
                    _this.scrollSubscription = rxjs.fromEvent(_this.scrollContents[key], 'scroll')
                        .pipe(operators.debounceTime(20, animationFrame.animationFrame))
                        .subscribe(( /**
                 * @return {?}
                 */function () {
