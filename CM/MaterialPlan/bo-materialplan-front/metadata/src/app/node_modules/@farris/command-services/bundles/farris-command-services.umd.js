(function (global, factory) {
    ...
    (factory((global.farris = global.farris || {}, global.farris['command-services'] = {}),global.uiLoading,global.uiMessager,global.uiNotify,global.uiWizard,global.ng.router,global.extendPageModal,global.lodash,global.rxjs['observable/zip'],global.rxjs['observable/empty'],global.uiVerifyDetail,global.Mousetrap,global.rxjs['observable/of'],global.rtdevkit,global.uiFlowchart,global.cloudprint,global.formdocUpload,global.fileViewer,global.uiModal,global.uiSidebar,global.rtfCommon,global.componentQuerycondition,global.dateFns,global.bef,global.date,global.ng.common.http,global.moment,global.uiDatagrid,global.uiTooltip,global.uiFeatureEditor,global.bignumber_js,global.rxjs,global.rxjs.operators,global.uiBatchEditDialog,global.querysolution,global.uiListFilter,global.wfTaskHandler,global.ng.core,global.devkit));
}(this, (function (exports,uiLoading,uiMessager,uiNotify,uiWizard,router,extendPageModal,lodash,zip,empty,uiVerifyDetail,Mousetrap,of,rtdevkit,uiFlowchart,cloudprint,formdocUpload,fileViewer,uiModal,uiSidebar,rtfCommon,componentQuerycondition,dateFns,bef,date,http,moment,uiDatagrid,uiTooltip,uiFeatureEditor,bignumber_js,rxjs,operators,uiBatchEditDialog,querysolution,uiListFilter,wfTaskHandler,core,devkit) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CardDataService = /** @class */ (function () {
        ...
        CardDataService.prototype.cancelWithCheck = function () {
            var _this = this;
            // @todel
            var hasUnSavedChanges = bef.BefRepositoryUtil.isExistUnsaveData(this.repository);
    ...
    var ListDataService = /** @class */ (function () {
        ...
        ListDataService.prototype.cancel = function () {
            ...
            // 没有变更时直接取消
            var befRepository = this.repository;
            var hasUnsavedData = bef.BefRepositoryUtil.isExistUnsaveData(befRepository);
            if (hasUnsavedData === false) {
                return this._cancel();
            }
            var confirmResult$ = this.msgService.question(this.languageService['cancelWithoutSave']).pipe(operators.switchMap(function (ifCancel) {
                if (ifCancel === false) {
                    return rxjs.EMPTY;
                }
    ...
    var TreeDataService = /** @class */ (function (_super) {
        ...
        TreeDataService.prototype.cancel = function () {
            ...
            var confirmResult$ = this.messageService.question(this.languageService['cancelWithoutSave']).pipe(operators.switchMap(function (ifCancel) {
                if (ifCancel === false) {
                    return rxjs.EMPTY;
                }
                return _this._cancel();
    ...
    var DialogService = /** @class */ (function () {
        ...
        DialogService.prototype.createModalComponentRef = function (config, component, uiStateObject) {
            ...
            if (frameContext && componentFactoryResolver) {
                ...
                var modalContentInjector = core.ReflectiveInjector.resolveAndCreate(__spread(this._providers), frameContext.injector);
                componentRef = contentCmptFactory.create(modalContentInjector);
                if (componentRef && componentRef.instance && componentRef.instance.viewModel && componentRef.instance.viewModel.uiState) {
                    if (typeof uiStateObject === 'object' && Object.keys(uiStateObject).length) {
                        Object.keys(uiStateObject).forEach(function (item) {
