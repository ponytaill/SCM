(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('lodash-es'), require('@angular/core'), require('@angular/common'), require('@farris/ui-common'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-loading', ['exports', 'rxjs', 'rxjs/operators', 'lodash-es', '@angular/core', '@angular/common', '@farris/ui-common', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-loading'] = {}),global.rxjs,global.rxjs.operators,global.lodashEs,global.ng.core,global.ng.common,global.uiCommon,global.uiLocale));
}(this, (function (exports,rxjs,operators,lodashEs,core,common,uiCommon,uiLocale) { 'use strict';
