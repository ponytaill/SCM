    ...
    ***************************************************************************** */
    ...
    var BaseComboComponent = /** @class */ (function () {
        function BaseComboComponent(el, cdr, document, render, comboService, injector) {
            ...
            this.willHide$.pipe(operators.takeUntil(this.destroy$)).subscribe(( /**
             * @param {?} e
             * @return {?}
             */function (e) {
         ...
         */
            function (value, searchParam) {
                ...
                this.initdataSubscription = this.comboService.initData(params, method, this.selectedValues).pipe(operators.throwIfEmpty(focusInput)).subscribe(( /**
                 * @param {?} n
                 * @return {?}
                 */function (n) {
                    if (!_this.isOpen) {
