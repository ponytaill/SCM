(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('resize-observer-polyfill'), require('@farris/ui-common/column'), require('@angular/platform-browser'), require('lodash-es'), require('@angular/core'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-common', ['exports', 'resize-observer-polyfill', '@farris/ui-common/column', '@angular/platform-browser', 'lodash-es', '@angular/core', 'rxjs', 'rxjs/operators'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-common'] = {}),global.ResizeObserver,global.farris['ui-common'].column,global.ng.platformBrowser,global.lodashEs,global.ng.core,global.rxjs,global.rxjs.operators));
}(this, (function (exports,ResizeObserver,column,platformBrowser,lodashEs,i0,rxjs,operators) { 'use strict';
