(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@farris/ui-datagrid'), require('@angular/forms'), require('rxjs/operators'), require('@farris/ui-locale'), require('resize-observer-polyfill'), require('@angular/common'), require('@farris/ui-time-picker'), require('@farris/ui-datepicker'), require('@farris/ui-number-spinner'), require('@farris/ui-datalist'), require('lodash-es')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-datagrid-filter', ['exports', '@angular/core', 'rxjs', '@farris/ui-datagrid', '@angular/forms', 'rxjs/operators', '@farris/ui-locale', 'resize-observer-polyfill', '@angular/common', '@farris/ui-time-picker', '@farris/ui-datepicker', '@farris/ui-number-spinner', '@farris/ui-datalist', 'lodash-es'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['ui-datagrid-filter'] = {}), global.ng.core, global.rxjs, global.uiDatagrid, global.ng.forms, global.rxjs.operators, global.uiLocale, global.ResizeObserver, global.ng.common, global.uiTimePicker, global.uiDatepicker, global.uiNumberSpinner, global.uiDatalist, global.lodashEs));
}(this, function (exports, core, rxjs, uiDatagrid, forms, operators, uiLocale, ResizeObserver, common, uiTimePicker, uiDatepicker, uiNumberSpinner, uiDatalist, lodashEs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FilterRowComponent = /** @class */ (function () {
        function FilterRowComponent(fb, el, ngzone, cd, dfrs, render, inject) {
            ...
            this.filterRowConditionsScribe = this.dfrs.filterRowConditions$.pipe(operators.debounceTime(this.delay)).subscribe((/**
             * @param {?} ccs
             * @return {?}
             */
            function (ccs) {
