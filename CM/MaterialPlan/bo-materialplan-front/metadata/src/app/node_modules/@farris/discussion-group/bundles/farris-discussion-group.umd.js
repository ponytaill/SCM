(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser'), require('@farris/ui-dialog'), require('@farris/ui-common'), require('@farris/ui-tree'), require('@farris/ui-modal'), require('@farris/ui-loading'), require('@farris/ui-locale'), require('@farris/ui-modal/component-loader'), require('@farris/ui-modal/positioning'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-pagination'), require('@farris/ui-notify'), require('@farris/ui-input-group'), require('@angular/common/locales/zh'), require('@angular/common/http'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/discussion-group', ['exports', 'rxjs', '@angular/common', '@angular/forms', '@angular/platform-browser', '@farris/ui-dialog', '@farris/ui-common', '@farris/ui-tree', '@farris/ui-modal', '@farris/ui-loading', '@farris/ui-locale', '@farris/ui-modal/component-loader', '@farris/ui-modal/positioning', '@farris/ui-perfect-scrollbar', '@farris/ui-pagination', '@farris/ui-notify', '@farris/ui-input-group', '@angular/common/locales/zh', '@angular/common/http', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['discussion-group'] = {}),global.rxjs,global.ng.common,global.ng.forms,global.ng.platformBrowser,global.uiDialog,global.uiCommon,global.uiTree,global.uiModal,global.uiLoading,global.uiLocale,global.componentLoader,global.positioning,global.uiPerfectScrollbar,global.uiPagination,global.uiNotify,global.uiInputGroup,global.ng.common.locales.zh,global.ng.common.http,global.ng.core));
}(this, (function (exports,rxjs,common,forms,platformBrowser,uiDialog,uiCommon,uiTree,uiModal,uiLoading,uiLocale,componentLoader,positioning,uiPerfectScrollbar,uiPagination,uiNotify,uiInputGroup,zh,http,i0) { 'use strict';
