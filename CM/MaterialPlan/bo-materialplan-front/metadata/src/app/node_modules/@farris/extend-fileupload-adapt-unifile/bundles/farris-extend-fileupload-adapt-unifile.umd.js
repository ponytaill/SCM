(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@farris/ui-notify'), require('@gsp-svc/file-viewer'), require('@gsp-svc/formdoc-upload'), require('@farris/extend-file-upload'), require('rxjs'), require('rxjs/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@farris/extend-fileupload-adapt-unifile', ['exports', '@angular/core', '@farris/ui-notify', '@gsp-svc/file-viewer', '@gsp-svc/formdoc-upload', '@farris/extend-file-upload', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['extend-fileupload-adapt-unifile'] = {}), global.ng.core, global.uiNotify, global.fileViewer, global.formdocUpload, global.extendFileUpload, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (exports, core, uiNotify, fileViewer, formdocUpload, extendFileUpload, rxjs, operators, common) { 'use strict';
