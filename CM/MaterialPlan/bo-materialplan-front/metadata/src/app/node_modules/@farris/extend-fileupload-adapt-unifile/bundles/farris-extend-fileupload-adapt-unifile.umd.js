(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@gsp-svc/file-viewer'), require('@gsp-svc/formdoc-upload'), require('@farris/extend-file-upload'), require('rxjs'), require('rxjs/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@farris/extend-fileupload-adapt-unifile', ['exports', '@angular/core', '@gsp-svc/file-viewer', '@gsp-svc/formdoc-upload', '@farris/extend-file-upload', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['extend-fileupload-adapt-unifile'] = {}), global.ng.core, global.fileViewer, global.formdocUpload, global.extendFileUpload, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (exports, core, fileViewer, formdocUpload, extendFileUpload, rxjs, operators, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FfileuploadAdaptUnifileService = /** @class */ (function (_super) {
        ...
        function (file) {
            ...
            return this.uploadSer['http']['http'].post(url, file.chunks[file.total]).pipe(operators.switchMap((/**
             * @return {?}
             */
            function () {
                return rxjs.of(file);
    ...
    var FfileuploadAdaptUnifileModule = /** @class */ (function () {
        ...
        FfileuploadAdaptUnifileModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: [extendFileUpload.FFileUploadModule, FFilePreviewAdaptUnifileDirective, FfilepreviewAdaptSeeimgComponent, FFileAdaptDownloadFileDirective, FFileAdaptPreviewFileDirective],
                        providers: [
                            FFileUploadAdaptUnifileConfigService,
                            FfilepreviewAdaptUnifileService,
                            fileViewer.FileViewerService
