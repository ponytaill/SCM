(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/platform-browser'), require('@angular/forms'), require('@farris/ui-common'), require('quill'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-html-editor', ['exports', '@angular/common', '@angular/platform-browser', '@angular/forms', '@farris/ui-common', 'quill', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-html-editor'] = {}),global.ng.common,global.ng.platformBrowser,global.ng.forms,global.uiCommon,global.Quill,global.ng.core));
}(this, (function (exports,common,platformBrowser,forms,uiCommon,Quill,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var HtmlEditorComponent = /** @class */ (function () {
        function HtmlEditorComponent(elementRef, domSanitizer, doc, platformId, renderer, zone, config) {
            var _this = this;
