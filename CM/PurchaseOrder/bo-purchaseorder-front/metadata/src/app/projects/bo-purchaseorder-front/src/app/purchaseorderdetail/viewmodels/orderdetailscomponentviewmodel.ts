...
@Injectable()
export class OrderdetailsComponentViewmodel extends ViewModel {
    public bindingPath = '/orderDetailss';
    // farrisDataGrid列集合定义 在对应component中赋值
    public dataGrid_orderdetailsColumns:any;
  ...
  "dataGrid_orderdetails": {
    ...
    public orderdetailsAddItem1(commandParam?: any): Observable<any> { return; }
    ...
    public orderdetailsRemoveItem1(commandParam?: any): Observable<any> { return; }
