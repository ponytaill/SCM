...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.stateMachine.stateChange.subscribe(() => {
            const pageHeaderToolbarToolbarItemsstates = {
                ...
                'button-edit': this.viewModel.stateMachine['canStore'],
                ...
                'toolBarItem-kw71': this.viewModel.stateMachine['canStore'],
            }
    ...
    pageHeaderToolbarToolbarItems = [{
        ...
        "id": "toolBarItem-9y89",
        "text": this.langService.transform('toolBarItem-9y89', this.lang, "查看变更日志"),
        ...
        "id": "toolBarItem-lo8j",
        "text": this.langService.transform('toolBarItem-lo8j', this.lang, "打印"),
        ...
        "id": "toolBarItem-kw71",
        "text": this.langService.transform('toolBarItem-kw71', this.lang, "提交订单"),
    ...
    fieldConfigsqueryscheme1 = [
        {
            ...
            "labelCode": "ID",
            "code": "ID",
            "name": this.langService.transform('QueryScheme/query-scheme-1/dadae0fb-54bb-4ed6-a545-a515d1b28040', this.lang, "主键"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/dadae0fb-54bb-4ed6-a545-a515d1b28040/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "labelCode": "Version",
            "code": "Version",
            "name": this.langService.transform('QueryScheme/query-scheme-1/cb1fe066-486c-44e1-ac69-398598d5265f', this.lang, "版本"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/cb1fe066-486c-44e1-ac69-398598d5265f/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "labelCode": "OrderCode",
            "code": "OrderCode",
            "name": this.langService.transform('QueryScheme/query-scheme-1/57e3230a-9a80-48c2-97b0-785bb6c77fe2', this.lang, "订单编号"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/57e3230a-9a80-48c2-97b0-785bb6c77fe2/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "labelCode": "OrderName",
            "code": "OrderName",
            "name": this.langService.transform('QueryScheme/query-scheme-1/547b5e91-bb43-463e-8898-bf5f87ca15f1', this.lang, "订单名称"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/547b5e91-bb43-463e-8898-bf5f87ca15f1/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "code": "PurchaseDept",
            "name": this.langService.transform('QueryScheme/query-scheme-1/77e5638b-b411-490b-88b5-dce038429686', this.lang, "采购部门"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/77e5638b-b411-490b-88b5-dce038429686/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "code": "ID",
            "name": this.langService.transform('QueryScheme/query-scheme-1/ad7604d9-6461-4cb6-a7d9-631d4764910b', this.lang, "采购部门"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/ad7604d9-6461-4cb6-a7d9-631d4764910b/placeHolder', this.lang, ""),
            "control": {
                "controltype": "help",
                "require": false,
                ...
                "editable": false,
                "dialogTitle": this.langService.transform('QueryScheme/query-scheme-1/ad7604d9-6461-4cb6-a7d9-631d4764910b/control/help/dialogTitle', this.lang, ""),
                "singleSelect": true,
                "enableCascade": false,
                "pageSize": 20,
        ...
        },
        {
            ...
            "code": "name",
            "name": this.langService.transform('QueryScheme/query-scheme-1/2c6c71c1-fb98-47cb-a806-7e89b050d591', this.lang, "名称"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/2c6c71c1-fb98-47cb-a806-7e89b050d591/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "code": "Purchaser",
            "name": this.langService.transform('QueryScheme/query-scheme-1/57e9e09f-9b5c-4d6a-a497-4d5d7db904b4', this.lang, "采购员"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/57e9e09f-9b5c-4d6a-a497-4d5d7db904b4/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "code": "ID",
            "name": this.langService.transform('QueryScheme/query-scheme-1/981a9463-30e2-41c9-884c-d234ce80bec8', this.lang, "采购人"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/981a9463-30e2-41c9-884c-d234ce80bec8/placeHolder', this.lang, ""),
            "control": {
                "controltype": "help",
                "require": false,
                ...
                "enableFullTree": false,
                "editable": false,
                "dialogTitle": this.langService.transform('QueryScheme/query-scheme-1/981a9463-30e2-41c9-884c-d234ce80bec8/control/help/dialogTitle', this.lang, ""),
                "singleSelect": true,
                "enableCascade": false,
                "pageSize": 20,
                "pageList": "10,20,30,50,100",
        ...
        },
        {
            ...
            "code": "Name",
            "name": this.langService.transform('QueryScheme/query-scheme-1/c5bf6949-627b-4cd8-9b65-42db21acf995', this.lang, "名称"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/c5bf6949-627b-4cd8-9b65-42db21acf995/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "labelCode": "OrderDate",
            "code": "OrderDate",
            "name": this.langService.transform('QueryScheme/query-scheme-1/a51eb05d-b4c3-4c45-8a30-95eae4357279', this.lang, "下单日期"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/a51eb05d-b4c3-4c45-8a30-95eae4357279/placeHolder', this.lang, ""),
        ...
        },
        {
            ...
            "code": "TotalPrice",
            "name": this.langService.transform('QueryScheme/query-scheme-1/a5be115d-f47f-4b2b-aa4a-0920ff22d51a', this.lang, "物料总价"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/a5be115d-f47f-4b2b-aa4a-0920ff22d51a/placeHolder', this.lang, ""),
