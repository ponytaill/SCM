...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        const states = {
                'orderdetailsAddButton': !this.viewModel.stateMachine['canAddDetail'],
                'orderdetailsRemoveButton': !this.viewModel.stateMachine['canRemoveDetail'],
        }; 
        ...
        contents: [
            {
                ...
                visible: true,
                title: this.langService.transform('orderdetailsAddButton', this.lang, "新增"),
                click: () => { this.viewModel.orderdetailsComponentViewmodel.orderdetailsAddItem1(); },
                appearance: {
            ...
            },
            {
                ...
                visible: true,
                title: this.langService.transform('orderdetailsRemoveButton', this.lang, "删除"),
                click: () => { this.viewModel.orderdetailsComponentViewmodel.orderdetailsRemoveItem1(); },
                appearance: {
                    "class": "btn btn-secondary f-btn-ml"
                }
            }
    ...
    orderdetailstabpage = this.langService.transform('orderdetails-tab-page', this.lang, "采购订单明细");
