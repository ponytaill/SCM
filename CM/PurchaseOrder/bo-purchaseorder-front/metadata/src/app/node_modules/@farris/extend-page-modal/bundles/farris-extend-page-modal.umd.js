(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@farris/extend-page-modal', ['exports', '@angular/platform-browser', '@farris/ui-modal/utils', 'rxjs', '@angular/core', '@angular/common', '@farris/ui-perfect-scrollbar', '@farris/ui-draggable', '@farris/ui-modal/positioning', '@farris/ui-modal/component-loader', '@farris/ui-area-response'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['extend-page-modal'] = {}),global.ng.platformBrowser,global.utils,global.rxjs,global.ng.core,global.ng.common,global.uiPerfectScrollbar,global.uiDraggable,global.positioning,global.i1,global.uiAreaResponse));
}(this, (function (exports,platformBrowser,utils,rxjs,i0,common,uiPerfectScrollbar,uiDraggable,positioning,i1,uiAreaResponse) { 'use strict';
