...
import { Map as Map$1, List } from 'immutable';
...
import { __extends, __spread, __assign, __values, __generator, __read } from 'tslib';
...
var ChangeSet = /** @class */ (function () {
    ...
    ChangeSet.prototype.appendRemoveModification = function (modification) {
        ...
        this.modifications.forEach(function (addModification) {
            ...
            if (isEqual$1(addModification.path, path) === false) {
                return;
            }
        ...
        this.modifications = this.modifications.filter(function (valueModification) {
            ...
            valueChangePath.pop();
            // 路径相同进行移除
            var isToRemove = isEqual$1(valueChangePath, fullRemovePath);
            return !isToRemove;
        });
        // 先删除下级删除变更，再插入
    ...
    ChangeSet.prototype.findNewAddItemsPath = function (path) {
        return this.modifications.find(function (value, index) {
            return isEqual$1(path, value.path) && (value.type === ModifyType.Add || value.type === ModifyType.Insert || value.type === ModifyType.Clone);
        });
    };
    /**
    ...
    ChangeSet.prototype.findModifyItemsPath = function (path) {
        return this.modifications.find(function (value, index) {
            return isEqual$1(path, value.path) && value.type === ModifyType.ValueChange;
        });
    };
    /**
     * 删除后代（包括自己）所有的删除变更
