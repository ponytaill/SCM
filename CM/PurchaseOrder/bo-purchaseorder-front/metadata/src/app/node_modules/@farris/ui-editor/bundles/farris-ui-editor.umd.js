    ...
    var EditorComponent = /** @class */ (function (_super) {
         ...
         */
            function (isfirstInit) {
                ...
                /** @type {?} */
                var finalInit = __assign({}, this.init, { target: this._element, inline: this.inline, plugins: mergePlugins(this.init && this.init.plugins, this.plugins), toolbar: this.init && this.init.toolbar, height: this.height, autoresize_max_height: this.autoresizeMaxHeight, setup: ( /**
                         * @param {?} editor
                         * @return {?}
                         */function (editor) {
