        ...
        function () {
            ...
            function () {
                if (_this.scrollSpies[key]) {
                    ...
                    /** @type {?} */
                    var topElementInView_1 = elements.filter((/**
                     * @param {?} el
                     * @return {?}
                     */
                    function (el) {
                    ...
                    if (!topElementInView_1 || !topElementInView_1.length) {
                        return;
                    }
                    //排序按照设置Spy的顺序，假定顺序是一致的 {id}
                    /** @type {?} */
                    var qlSpyItem = _this.scrollFollowSpipes[key].find((/**
                     * @param {?} spyItem
                     * @return {?}
                     */
                    function (spyItem) {
                        /** @type {?} */
                        var eqElItem = topElementInView_1.find((/**
                         * @param {?} elItem
                         * @return {?}
                         */
                        function (elItem) {
                    ...
                    /** @type {?} */
                    var topElementId_1 = qlSpyItem ? qlSpyItem.id : topElementInView_1[0].id;
                    //判断 点击是否是点击引起的滚动
