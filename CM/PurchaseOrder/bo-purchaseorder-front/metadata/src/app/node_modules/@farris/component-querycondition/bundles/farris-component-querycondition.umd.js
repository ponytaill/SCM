(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-modal'), require('lodash-es'), require('@farris/ui-notify'), require('@angular/common'), require('@farris/ui-dialog'), require('@farris/ui-layout'), require('@farris/ui-lookup'), require('@farris/ui-multi-select'), require('@farris/ui-field-group'), require('@farris/ui-input-group'), require('@farris/ui-dropdown'), require('@farris/ui-loading'), require('@farris/ui-locale'), require('@farris/ui-combo-list'), require('@farris/ui-number-spinner'), require('@farris/ui-forms'), require('@farris/ui-datepicker'), require('rxjs'), require('rxjs/operators'), require('@farris/ui-combo-lookup'), require('@angular/forms'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/component-querycondition', ['exports', '@farris/ui-modal', 'lodash-es', '@farris/ui-notify', '@angular/common', '@farris/ui-dialog', '@farris/ui-layout', '@farris/ui-lookup', '@farris/ui-multi-select', '@farris/ui-field-group', '@farris/ui-input-group', '@farris/ui-dropdown', '@farris/ui-loading', '@farris/ui-locale', '@farris/ui-combo-list', '@farris/ui-number-spinner', '@farris/ui-forms', '@farris/ui-datepicker', 'rxjs', 'rxjs/operators', '@farris/ui-combo-lookup', '@angular/forms', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['component-querycondition'] = {}),global.uiModal,global.lodashEs,global.uiNotify,global.ng.common,global.uiDialog,global.uiLayout,global.uiLookup,global.uiMultiSelect,global.uiFieldGroup,global.uiInputGroup,global.uiDropdown,global.uiLoading,global.uiLocale,global.uiComboList,global.uiNumberSpinner,global.uiForms,global.uiDatepicker,global.rxjs,global.rxjs.operators,global.uiComboLookup,global.ng.forms,global.ng.core));
}(this, (function (exports,uiModal,lodashEs,uiNotify,common,uiDialog,uiLayout,uiLookup,uiMultiSelect,uiFieldGroup,uiInputGroup,uiDropdown,uiLoading,uiLocale,uiComboList,uiNumberSpinner,uiForms,uiDatepicker,rxjs,operators,uiComboLookup,forms,core) { 'use strict';
