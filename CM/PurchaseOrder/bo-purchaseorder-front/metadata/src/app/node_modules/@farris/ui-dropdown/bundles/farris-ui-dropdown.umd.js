(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@farris/ui-common'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-dropdown', ['exports', 'rxjs', '@farris/ui-common', '@angular/core', '@angular/common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-dropdown'] = {}),global.rxjs,global.uiCommon,global.ng.core,global.ng.common));
}(this, (function (exports,rxjs,uiCommon,core,common) { 'use strict';
    ...
    var FDropdownMenuDirective = /** @class */ (function () {
         ...
         */
            function () {
                ...
                var _b = this.elementRef.nativeElement.getBoundingClientRect(), pw = _b.width, ph = _b.height;
                /** @type {?} */
                var _top = top + height;
                /** @type {?} */
                var _left = left;
                ...
                if (!this.issubMenu()) {
                    ...
                    if (childMenuPanel.offsetWidth > childContainerWidth) {
                        /** @type {?} */
                        var l = -parentMenuPanel.offsetWidth + 16;
