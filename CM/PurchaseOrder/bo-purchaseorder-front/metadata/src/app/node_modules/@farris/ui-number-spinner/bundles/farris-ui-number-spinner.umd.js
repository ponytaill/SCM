            ...
            function (e, type) {
                if (!this.readonly && !this.disabled) {
                    ...
                    if (type === 'begin') {
                        ...
                        this.beginValue = this.validInterval(new bignumber_js.BigNumber(minValue)).toFixed();
                        ...
                        this.endValue = this.validInterval(new bignumber_js.BigNumber(maxValue)).toFixed();
         ...
         */
            function (type, dir, tagVal) {
                ...
                if (type === 'begin' && this.isDisableOfBtn(dir, this.prevValue)) {
                    ...
                    var v = r.toFixed();
                    /** @type {?} */
                    var minValue = bignumber_js.BigNumber.min(v, ev);
                    ...
                    var ev = tagVal || 0;
                    /** @type {?} */
                    var r = new bignumber_js.BigNumber(ev)[m](Number(this.step));
                    /** @type {?} */
                    var v = r.toFixed();
                    /** @type {?} */
                    var maxValue = bignumber_js.BigNumber.max(bv, v);
