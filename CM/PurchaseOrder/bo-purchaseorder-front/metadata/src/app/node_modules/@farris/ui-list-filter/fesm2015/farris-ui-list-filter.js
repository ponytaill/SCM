...
import { EventEmitter, Injectable, Directive, Input, Optional, Self, Injector, NgModule, Component, ViewChild, ChangeDetectorRef, ChangeDetectionStrategy, Output, ElementRef, Renderer2, LOCALE_ID, InjectFlags, Pipe, ViewEncapsulation, InjectionToken, HostBinding, defineInjectable } from '@angular/core';
