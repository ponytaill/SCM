...
export declare class ProcessDesignerViewModel {
    ...
    saveAsProcess(process: any, processInfo: ProcessInfo): void;
    /**
     * 同步设计器时流程定义
     */
    syncDtProcess(content: string, rtProcessInfo: RTProcessInfo): void;
