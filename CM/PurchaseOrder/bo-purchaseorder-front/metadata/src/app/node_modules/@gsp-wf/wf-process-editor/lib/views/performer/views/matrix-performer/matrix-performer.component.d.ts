...
export declare class MatrixPerformerComponent implements OnInit {
    ...
    constructor(http: HttpService, designerUIState: ProcessDesignerUIState, expr: ExpressionService, modalService: BsModalService, resolver: ComponentFactoryResolver, injector: Injector);
    ngOnInit(): void;
    /**
     * 获取矩阵定义
     */
