...
var OrderdetailsComponentViewmodelForm = /** @class */ (function (_super) {
    tslib_1.__extends(OrderdetailsComponentViewmodelForm, _super);
    ...
    OrderdetailsComponentViewmodelForm = tslib_1.__decorate([
        Injectable(),
        NgValidateForm({
...
export { OrderdetailsComponentViewmodelForm };
