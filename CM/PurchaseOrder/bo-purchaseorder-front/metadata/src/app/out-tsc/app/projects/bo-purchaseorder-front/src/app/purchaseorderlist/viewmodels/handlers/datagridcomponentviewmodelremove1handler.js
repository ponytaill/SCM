...
var datagridcomponentviewmodelRemove1Handler = /** @class */ (function (_super) {
    tslib_1.__extends(datagridcomponentviewmodelRemove1Handler, _super);
    ...
    datagridcomponentviewmodelRemove1Handler = tslib_1.__decorate([
        Injectable(),
        NgCommandHandler({
...
export { datagridcomponentviewmodelRemove1Handler };
