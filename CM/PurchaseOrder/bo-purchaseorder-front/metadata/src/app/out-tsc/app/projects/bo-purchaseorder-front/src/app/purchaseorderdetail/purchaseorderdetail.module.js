...
import { PurchaseOrderDetailRoutingModule } from './routing';
...
import { OrderdetailsComponent } from './components/orderdetails-component/orderdetailscomponent';
...
var PurchaseOrderDetailModule = /** @class */ (function () {
    ...
    PurchaseOrderDetailModule = tslib_1.__decorate([
        NgModule({
            exports: [
                RootComponent
            ],
...
export { PurchaseOrderDetailModule };
