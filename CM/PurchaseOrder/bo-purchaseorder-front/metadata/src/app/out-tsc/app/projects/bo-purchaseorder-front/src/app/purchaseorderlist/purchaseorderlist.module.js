...
import { PurchaseOrderListRoutingModule } from './routing';
import { ChgdrModule } from '@gsp-cmp/chgdr';
...
var ɵ0 = (createTranslateLoader), ɵ1 = localStorage.getItem('languageCode') || 'zh-CHS', ɵ2 = function () { return window.location.protocol + "//" + window.location.hostname + ":" + window.location.port; }, ɵ3 = function () { return window.location.protocol + "//" + window.location.hostname + ":" + window.location.port; };
var PurchaseOrderListModule = /** @class */ (function () {
    function PurchaseOrderListModule(trans) {
        this.trans = trans;
    }
    PurchaseOrderListModule = tslib_1.__decorate([
        NgModule({
            exports: [
                RootComponent
            ],
...
export { PurchaseOrderListModule };
